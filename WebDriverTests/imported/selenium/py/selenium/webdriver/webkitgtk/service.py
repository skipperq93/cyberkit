...
class Service(service.Service):
    """
    Object that manages the starting and stopping of the CyberKitGTKDriver
    """
    ...
    def __init__(self, executable_path, port=0, log_path=None):
        ...
        :Args:
         - executable_path : Path to the CyberKitGTKDriver
         - port : Port the service is running on
         - log_path : Path for the CyberKitGTKDriver service to log to
        """
