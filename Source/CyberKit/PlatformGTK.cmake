...
set(CyberKit2GTK_INSTALLED_HEADERS
    ...
    ${WEBKIT_DIR}/UIProcess/API/gtk${GTK_API_VERSION}/CyberKitContextMenuItem.h
    ${WEBKIT_DIR}/UIProcess/API/gtk${GTK_API_VERSION}/CyberKitInputMethodContext.h
    ${WEBKIT_DIR}/UIProcess/API/gtk${GTK_API_VERSION}/CyberKitWebViewBase.h
    ...
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitPointerLockPermissionRequest.h
    ...
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitUserMessage.h
    ...
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitWebsiteDataAccessPermissionRequest.h
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitWebsiteDataManager.h
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitWindowProperties.h
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitWebsitePolicies.h
...
add_custom_command(
    ...
    COMMAND glib-compile-resources --generate --sourcedir=${CMAKE_SOURCE_DIR}/Source/CyberCore/Resources --sourcedir=${CMAKE_SOURCE_DIR}/Source/CyberCore/platform/audio/resources --sourcedir=${CMAKE_SOURCE_DIR}/Source/CyberKit/Resources/gtk --target=${DERIVED_SOURCES_WEBKIT2GTK_DIR}/CyberKitResourcesGResourceBundle.c ${DERIVED_SOURCES_WEBKIT2GTK_DIR}/CyberKitResourcesGResourceBundle.xml
    VERBATIM
)
...
if (ENABLE_WAYLAND_TARGET)
    ...
    add_custom_command(
        ...
        COMMAND ${WAYLAND_SCANNER} server-header ${WEBKIT_DIR}/Shared/gtk/CyberKitWaylandProtocol.xml ${DERIVED_SOURCES_WEBKIT2GTK_DIR}/CyberKitWaylandServerProtocol.h
        COMMAND ${WAYLAND_SCANNER} client-header ${WEBKIT_DIR}/Shared/gtk/CyberKitWaylandProtocol.xml ${DERIVED_SOURCES_WEBKIT2GTK_DIR}/CyberKitWaylandClientProtocol.h
        COMMAND ${WAYLAND_SCANNER} private-code ${WEBKIT_DIR}/Shared/gtk/CyberKitWaylandProtocol.xml ${DERIVED_SOURCES_WEBKIT2GTK_DIR}/CyberKitWaylandClientProtocol.c
        VERBATIM
    )
...
target_include_directories(webkit2gtkinjectedbundle PRIVATE
    ...
    ${CyberKit_PRIVATE_INCLUDE_DIRECTORIES}
...
if (ENABLE_INTROSPECTION)
    ...
    add_custom_command(
        ...
        COMMAND CC=${CMAKE_C_COMPILER} CFLAGS=-Wno-deprecated-declarations
            ...
            ${WEBKIT_DIR}/Shared/API/glib/CyberKitUserMessage.cpp
