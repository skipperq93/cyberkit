...
# CyberCore should be specifed before and after CyberCorePlatformGTK
list(APPEND CyberKit_LIBRARIES PRIVATE CyberCore)
...
if (ENABLE_PLUGIN_PROCESS_GTK2)
    set(PluginProcessGTK2_EXECUTABLE_NAME CyberKitPluginProcess2)

    # FIXME: We should remove CyberKitPluginProcess2 in 2020, once Flash is no longer supported.
    list(APPEND PluginProcessGTK2_SOURCES
        ...
        Shared/CyberCoreArgumentCoders.cpp
        Shared/WebEvent.cpp
        Shared/WebKeyboardEvent.cpp
        Shared/CyberKit2Initialize.cpp
        ...
        Shared/soup/CyberCoreArgumentCodersSoup.cpp
    ...
    add_executable(CyberKitPluginProcess2 ${PluginProcessGTK2_SOURCES})
    ADD_WEBKIT_PREFIX_HEADER(CyberKitPluginProcess2)
    ...
    set_property(
        TARGET CyberKitPluginProcess2
        APPEND
        PROPERTY COMPILE_DEFINITIONS GTK_API_VERSION_2=1
    )
    target_include_directories(CyberKitPluginProcess2 PRIVATE
        ${CyberKitCommonIncludeDirectories}
    )
    target_include_directories(CyberKitPluginProcess2 SYSTEM PRIVATE
         ${CyberKitCommonSystemIncludeDirectories}
         ${GTK2_INCLUDE_DIRS}
         ${GDK2_INCLUDE_DIRS}
    )

    set(CyberKitPluginProcess2_LIBRARIES
        ${SharedCyberKitLibraries}
        PRIVATE CyberCorePlatformGTK2
    )
    ADD_WHOLE_ARCHIVE_TO_LIBRARIES(CyberKitPluginProcess2_LIBRARIES)
    target_link_libraries(CyberKitPluginProcess2 ${CyberKitPluginProcess2_LIBRARIES})

    add_dependencies(CyberKitPluginProcess2 CyberKit)

    install(TARGETS CyberKitPluginProcess2 DESTINATION "${LIBEXEC_INSTALL_DIR}")

    if (COMPILER_IS_GCC_OR_CLANG)
        WEBKIT_ADD_TARGET_CXX_FLAGS(CyberKitPluginProcess2 -Wno-unused-parameter)
    endif ()
