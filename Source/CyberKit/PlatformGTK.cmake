...
set(CyberKit2GTK_INSTALLED_HEADERS
    ...
    ${WEBKIT_DIR}/UIProcess/API/gtk/CyberKitInputMethodContext.h
...
if (ENABLE_WAYLAND_TARGET)
    ...
    add_custom_command(
        ...
        COMMAND ${WAYLAND_SCANNER} code ${WEBKIT_DIR}/Shared/gtk/CyberKitWaylandProtocol.xml ${DERIVED_SOURCES_WEBKIT2GTK_DIR}/CyberKitWaylandClientProtocol.c
        VERBATIM
    )
