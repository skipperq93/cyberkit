...
set(CyberKitGTK_HEADER_TEMPLATES
    ...
    ${WEBKIT_DIR}/UIProcess/API/glib/CyberKitClipboardPermissionRequest.h.in
    ...
    ${WEBKIT_DIR}/UIProcess/API/glib/CyberKitFeature.h.in
...
list(INSERT CyberKit_PRIVATE_INCLUDE_DIRECTORIES 0
...
list(APPEND CyberKit_INTERFACE_INCLUDE_DIRECTORIES
    ${CyberKitGTK_DERIVED_SOURCES_DIR}
    ${CyberKitGTK_FRAMEWORK_HEADERS_DIR}/webkitgtk-web-process-extension
)
...
set(CyberKitCommonIncludeDirectories ${CyberKit_PRIVATE_INCLUDE_DIRECTORIES})
