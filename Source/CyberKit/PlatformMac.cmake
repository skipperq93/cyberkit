...
WEBKIT_CREATE_FORWARDING_HEADERS(CyberKit FILES ${CyberKit_FORWARDING_HEADERS_FILES} DIRECTORIES ${CyberKit_FORWARDING_HEADERS_DIRECTORIES})
...
foreach (_file ${ObjCHeaders})
    ...
    if (NOT EXISTS ${FORWARDING_HEADERS_DIR}/CyberKit/${_name})
        file(WRITE ${FORWARDING_HEADERS_DIR}/CyberKit/${_name} "#import <CyberKit/UIProcess/API/Cocoa/${_name}>")
    endif ()
endforeach ()
if (NOT EXISTS ${FORWARDING_HEADERS_DIR}/CyberKit/WKWebViewPrivateForTestingIOS.h)
    file(WRITE ${FORWARDING_HEADERS_DIR}/CyberKit/WKWebViewPrivateForTestingIOS.h "#import <CyberKit/UIProcess/API/ios/WKWebViewPrivateForTestingIOS.h>")
endif ()
if (NOT EXISTS ${FORWARDING_HEADERS_DIR}/CyberKit/WKWebViewPrivateForTestingMac.h)
    file(WRITE ${FORWARDING_HEADERS_DIR}/CyberKit/WKWebViewPrivateForTestingMac.h "#import <CyberKit/UIProcess/API/mac/WKWebViewPrivateForTestingMac.h>")
endif ()
...
foreach (_file ${CyberKitLegacyForwardingHeaders})
    file(WRITE ${FORWARDING_HEADERS_DIR}/CyberKit/${_file} "#import <CyberKitLegacy/${_file}>")
endforeach ()
...
set(SecItemShimDirectory ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/CyberKit.framework/Versions/A/Frameworks)
add_library(SecItemShim SHARED WebProcess/mac/SecItemShimLibrary.mm)
WEBKIT_CREATE_SYMLINK(SecItemShim ${SecItemShimDirectory} ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/CyberKit.framework/Frameworks)
...
add_dependencies(SecItemShim CyberCore)

# FIXME: These should not be necessary.
file(WRITE ${FORWARDING_HEADERS_DIR}/CyberKit/WKImageCG.h "#import <CyberKit/Shared/API/c/cg/WKImageCG.h>")
...
function(WEBKIT_DEFINE_XPC_SERVICES)
    ...
    add_custom_command(OUTPUT ${CyberKit_RESOURCES_DIR}/com.apple.WebProcess.sb COMMAND
        grep -o "^[^;]*" ${WEBKIT_DIR}/WebProcess/com.apple.WebProcess.sb.in | clang -E -P -w -include wtf/Platform.h -I ${FORWARDING_HEADERS_DIR} - > ${CyberKit_RESOURCES_DIR}/com.apple.WebProcess.sb
        VERBATIM)
    add_custom_command(OUTPUT ${CyberKit_RESOURCES_DIR}/com.matthewbenedict.CyberKit.NetworkProcess.sb COMMAND
        grep -o "^[^;]*" ${WEBKIT_DIR}/NetworkProcess/mac/com.matthewbenedict.CyberKit.NetworkProcess.sb.in | clang -E -P -w -include wtf/Platform.h -I ${FORWARDING_HEADERS_DIR} - > ${CyberKit_RESOURCES_DIR}/com.matthewbenedict.CyberKit.NetworkProcess.sb
        VERBATIM)
    add_custom_target(CyberKitSandboxProfiles ALL DEPENDS ${CyberKit_RESOURCES_DIR}/com.apple.WebProcess.sb ${CyberKit_RESOURCES_DIR}/com.matthewbenedict.CyberKit.NetworkProcess.sb)
