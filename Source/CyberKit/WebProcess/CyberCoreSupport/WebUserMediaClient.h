...
private:
    ...
    void enumerateMediaDevices(CyberCore::MediaDevicesEnumerationRequest&) final;
    void cancelMediaDevicesEnumerationRequest(CyberCore::MediaDevicesEnumerationRequest&) final;
