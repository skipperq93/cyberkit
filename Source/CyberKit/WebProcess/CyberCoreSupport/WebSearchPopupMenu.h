...
public:
    ...
    void saveRecentSearches(const WTF::AtomicString& name, const Vector<CyberCore::RecentSearch>&) override;
    void loadRecentSearches(const WTF::AtomicString& name, Vector<CyberCore::RecentSearch>&) override;
