...
WEBKIT_API void
webkit_web_extension_send_message_to_context        (CyberKitWebExtension *extension,
...
webkit_web_extension_send_message_to_context_finish (CyberKitWebExtension *extension,
                                                     GAsyncResult       *result,
                                                     GError            **error);
