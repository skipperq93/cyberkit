...
#ifndef CyberKitDOMHTMLDivElement_h
#define CyberKitDOMHTMLDivElement_h
...
#define WEBKIT_DOM_HTML_DIV_ELEMENT(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), WEBKIT_DOM_TYPE_HTML_DIV_ELEMENT, CyberKitDOMHTMLDivElement))
#define WEBKIT_DOM_HTML_DIV_ELEMENT_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_DOM_TYPE_HTML_DIV_ELEMENT, CyberKitDOMHTMLDivElementClass)
...
#define WEBKIT_DOM_HTML_DIV_ELEMENT_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS((obj),  WEBKIT_DOM_TYPE_HTML_DIV_ELEMENT, CyberKitDOMHTMLDivElementClass))

struct _CyberKitDOMHTMLDivElement {
    CyberKitDOMHTMLElement parent_instance;
};

struct _CyberKitDOMHTMLDivElementClass {
 ...
 * @self: A #CyberKitDOMHTMLDivElement
 *
 * Returns: A #gchar
 *
...
#endif /* CyberKitDOMHTMLDivElement_h */
