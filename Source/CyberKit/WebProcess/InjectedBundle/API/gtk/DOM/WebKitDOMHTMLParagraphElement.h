...
#ifndef CyberKitDOMHTMLParagraphElement_h
#define CyberKitDOMHTMLParagraphElement_h
...
#define WEBKIT_DOM_HTML_PARAGRAPH_ELEMENT(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), WEBKIT_DOM_TYPE_HTML_PARAGRAPH_ELEMENT, CyberKitDOMHTMLParagraphElement))
#define WEBKIT_DOM_HTML_PARAGRAPH_ELEMENT_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_DOM_TYPE_HTML_PARAGRAPH_ELEMENT, CyberKitDOMHTMLParagraphElementClass)
...
#define WEBKIT_DOM_HTML_PARAGRAPH_ELEMENT_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS((obj),  WEBKIT_DOM_TYPE_HTML_PARAGRAPH_ELEMENT, CyberKitDOMHTMLParagraphElementClass))

struct _CyberKitDOMHTMLParagraphElement {
    CyberKitDOMHTMLElement parent_instance;
};

struct _CyberKitDOMHTMLParagraphElementClass {
 ...
 * @self: A #CyberKitDOMHTMLParagraphElement
 *
 * Returns: A #gchar
 *
...
#endif /* CyberKitDOMHTMLParagraphElement_h */
