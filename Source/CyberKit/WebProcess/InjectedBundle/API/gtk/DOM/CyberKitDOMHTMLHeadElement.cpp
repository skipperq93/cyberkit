...
gchar* webkit_dom_html_head_element_get_profile(CyberKitDOMHTMLHeadElement* self)
{
    ...
    CyberCore::HTMLHeadElement* item = CyberKit::core(self);
    gchar* result = convertToUTF8String(item->attributeWithoutSynchronization(CyberCore::HTMLNames::profileAttr));
    return result;
}
...
void webkit_dom_html_head_element_set_profile(CyberKitDOMHTMLHeadElement* self, const gchar* value)
{
    ...
    item->setAttributeWithoutSynchronization(CyberCore::HTMLNames::profileAttr, convertedValue);
}
