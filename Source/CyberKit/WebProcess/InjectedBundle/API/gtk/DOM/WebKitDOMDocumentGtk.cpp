...
CyberKitDOMCSSStyleDeclaration* webkit_dom_document_get_override_style(CyberKitDOMDocument* self, CyberKitDOMElement* element, const gchar* pseudoElement)
{
    CyberCore::JSMainThreadNullState state;
    g_return_val_if_fail(WEBKIT_DOM_IS_DOCUMENT(self), 0);
    ...
    RefPtr<CyberCore::CSSStyleDeclaration> gobjectResult = WTF::getPtr(item->getOverrideStyle(convertedElement, convertedPseudoElement));
    return CyberKit::kit(gobjectResult.get());
}
...
CyberKitDOMElement* webkit_dom_document_get_webkit_current_fullscreen_element(CyberKitDOMDocument* self)
{
    ...
    g_return_val_if_fail(WEBKIT_DOM_IS_DOCUMENT(self), 0);
    CyberCore::Document* item = CyberKit::core(self);
    RefPtr<CyberCore::Element> gobjectResult = WTF::getPtr(item->webkitCurrentFullScreenElement());
    return CyberKit::kit(gobjectResult.get());
}
...
CyberKitDOMElement* webkit_dom_document_get_webkit_fullscreen_element(CyberKitDOMDocument* self)
{
    ...
    g_return_val_if_fail(WEBKIT_DOM_IS_DOCUMENT(self), 0);
    CyberCore::Document* item = CyberKit::core(self);
    RefPtr<CyberCore::Element> gobjectResult = WTF::getPtr(item->webkitFullscreenElement());
    return CyberKit::kit(gobjectResult.get());
}
