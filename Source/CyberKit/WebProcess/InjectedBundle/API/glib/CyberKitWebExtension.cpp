...
WEBKIT_DEFINE_TYPE(CyberKitWebExtension, webkit_web_extension, G_TYPE_OBJECT)
...
CyberKitWebExtension* webkitWebExtensionCreate(InjectedBundle* bundle)
{
...
void webkitWebExtensionDidReceiveUserMessage(CyberKitWebExtension* extension, UserMessage&& message)
{
...
void webkitWebExtensionSetGarbageCollectOnPageDestroy(CyberKitWebExtension* extension)
{
#if ENABLE(DEVELOPER_MODE)
