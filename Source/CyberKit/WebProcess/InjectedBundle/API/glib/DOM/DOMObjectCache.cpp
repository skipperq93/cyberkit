...
typedef HashMap<CyberCore::LocalFrame*, std::unique_ptr<DOMObjectCacheFrameObserver>> DOMObjectCacheFrameObserverMap;
...
public:
    DOMObjectCacheFrameObserver(CyberCore::LocalFrame& frame)
...
private:
    class DOMWindowObserver final : public CyberCore::LocalDOMWindow::Observer {
        WTF_MAKE_FAST_ALLOCATED;
    public:
        DOMWindowObserver(CyberCore::LocalDOMWindow& window, DOMObjectCacheFrameObserver& frameObserver)
            : m_window(window)
        ...
        CyberCore::LocalDOMWindow* window() const { return m_window.get(); }
    ...
    private:
        ...
        WeakPtr<CyberCore::LocalDOMWindow, CyberCore::WeakPtrImplWithEventTargetData> m_window;
...
static DOMObjectCacheFrameObserver& getOrCreateDOMObjectCacheFrameObserver(CyberCore::LocalFrame& frame)
{
