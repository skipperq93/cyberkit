...
bool WebProcessExtensionManager::initializeWebProcessExtension(Module* extensionModule, GVariant* userData)
{
    ...
    CyberKitWebProcessExtensionInitializeWithUserDataFunction initializeWithUserDataFunction =
        extensionModule->functionPointer<CyberKitWebProcessExtensionInitializeWithUserDataFunction>("webkit_web_process_extension_initialize_with_user_data");
#else
...
#if ENABLE(2022_GLIB_API)
    CyberKitWebProcessExtensionInitializeFunction initializeFunction =
        extensionModule->functionPointer<CyberKitWebProcessExtensionInitializeFunction>("webkit_web_process_extension_initialize");
#else
