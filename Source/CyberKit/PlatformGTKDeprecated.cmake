...
list(APPEND CyberKitWebExtension_HEADER_TEMPLATES
...
list(APPEND CyberKitGTK_FAKE_API_HEADERS
    ...
    ${CyberKitGTK_FRAMEWORK_HEADERS_DIR}/webkitgtk-webextension/webkitdom
)
...
add_custom_command(
    ...
    DEPENDS ${CyberKitGTK_DERIVED_SOURCES_DIR}/webkit/webkit-web-extension.h
    COMMAND ${CMAKE_COMMAND} -E copy ${CyberKitGTK_DERIVED_SOURCES_DIR}/webkit/webkit-web-extension.h ${CyberKitGTK_DERIVED_SOURCES_DIR}/webkit2/
    VERBATIM
)

add_custom_command(
    OUTPUT ${CyberKitGTK_FRAMEWORK_HEADERS_DIR}/webkitgtk-webextension/webkitdom
    DEPENDS ${WEBKIT_DIR}/WebProcess/InjectedBundle/API/gtk/DOM
    COMMAND ln -n -s -f ${WEBKIT_DIR}/WebProcess/InjectedBundle/API/gtk/DOM ${CyberKitGTK_FRAMEWORK_HEADERS_DIR}/webkitgtk-webextension/webkitdom
)
