...
function ios_family_process_webcontent_entitlements()
{
    ...
    plistbuddy Add :seatbelt-profiles:0 string com.matthewbenedict.CyberKit.WebContent
}
...
function ios_family_process_gpu_entitlements()
{
    ...
    plistbuddy Add :seatbelt-profiles array
    plistbuddy Add :seatbelt-profiles:0 string com.matthewbenedict.CyberKit.GPU
}
...
function ios_family_process_network_entitlements()
{
    ...
    plistbuddy Add :seatbelt-profiles array
    plistbuddy Add :seatbelt-profiles:0 string com.matthewbenedict.CyberKit.Networking
}
...
then
    ...
    elif [[ "${PRODUCT_NAME}" == com.matthewbenedict.CyberKit.Plugin.64 ]]; then mac_process_plugin_entitlements
...
then
    [[ "${RC_XBS}" != YES && ( "${PRODUCT_NAME}" == com.matthewbenedict.CyberKit.WebContent.Development || "${PRODUCT_NAME}" == com.matthewbenedict.CyberKit.Plugin.64 ) ]] && plistbuddy Add :com.apple.security.get-task-allow bool YES
    ...
    elif [[ "${PRODUCT_NAME}" == com.matthewbenedict.CyberKit.Plugin.64 ]]; then maccatalyst_process_plugin_entitlements
...
then
    ...
    elif [[ "${PRODUCT_NAME}" == com.matthewbenedict.CyberKit.Plugin.64 ]]; then ios_family_process_plugin_entitlements
