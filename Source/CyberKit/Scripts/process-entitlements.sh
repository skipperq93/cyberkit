...
[[ ${PRODUCT_NAME} =~ com.matthewbenedict.CyberKit.WebContent(.Development)? ]] && process_webcontent_entitlements
[[ ${PRODUCT_NAME} == com.matthewbenedict.CyberKit.Networking ]] && process_network_entitlements
[[ ${PRODUCT_NAME} == com.matthewbenedict.CyberKit.Plugin.64 ]] && process_plugin_entitlements
