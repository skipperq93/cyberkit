...
public:
    ...
    void setCursorRect(const CyberCore::IntRect&);

    using FilterKeyEventCompletionHandler = Function<void(const CyberCore::CompositionResults&, InputMethodFilter::EventFakedForComposition)>;
...
private:
    ...
    CyberCore::IntPoint m_lastCareLocation;
