...
WEBKIT_API void
webkit_authentication_request_set_can_save_credentials(CyberKitAuthenticationRequest *request,
                                                       gboolean                     enabled);
...
WEBKIT_API void
webkit_authentication_request_set_proposed_credential (CyberKitAuthenticationRequest *request,
...
webkit_authentication_request_get_security_origin     (CyberKitAuthenticationRequest *request);
