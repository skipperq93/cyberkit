...
// CyberKit coding style, using some internal types from WTF to simplify the implementation
...
struct _CyberKitEmojiChooserPrivate {
    GtkWidget* stack;
    GtkWidget* swindow;
...
WEBKIT_DEFINE_TYPE(CyberKitEmojiChooser, webkit_emoji_chooser, GTK_TYPE_POPOVER)

static void emojiPopupMenu(GtkWidget*, CyberKitEmojiChooser*);
...
static GtkWidget* webkitEmojiChooserAddEmoji(CyberKitEmojiChooser* chooser, GtkFlowBox* parent, GVariant* item, bool prepend = false, gunichar modifier = 0)
{
    char text[64];
    char* textPtr = text;
...
static void webkitEmojiChooserAddRecentItem(CyberKitEmojiChooser* chooser, GVariant* item, gunichar modifier)
{
...
static void emojiActivated(GtkFlowBox* box, GtkFlowBoxChild* child, CyberKitEmojiChooser* chooser)
{
...
static void webkitEmojiChooserShowVariations(CyberKitEmojiChooser* chooser, GtkWidget* child)
{
    if (!child)
        return;
...
static void emojiLongPressed(GtkGesture* gesture, double x, double y, CyberKitEmojiChooser* chooser)
{
...
static void emojiPressed(GtkGesture* gesture, int, double x, double y, CyberKitEmojiChooser* chooser)
{
    emojiLongPressed(gesture, x, y, chooser);
}

static void emojiPopupMenu(GtkWidget* child, CyberKitEmojiChooser* chooser)
{
    webkitEmojiChooserShowVariations(chooser, child);
}

static void verticalAdjustmentChanged(GtkAdjustment* adjustment, CyberKitEmojiChooser* chooser)
{
...
static GtkWidget* webkitEmojiChooserSetupSectionBox(CyberKitEmojiChooser* chooser, GtkBox* parent, const char* firstEmojiName, const char* title, GtkAdjustment* adjustment, gboolean canHaveVariations = FALSE)
{
...
static void webkitEmojiChooserSetupSectionButton(CyberKitEmojiChooser* chooser, GtkBox* parent, const char* iconName, const char* tooltip)
{
...
static void webkitEmojiChooserSetupRecent(CyberKitEmojiChooser* chooser, GtkBox* emojiBox, GtkBox* buttonBox, GtkAdjustment* adjustment)
{
...
static void webkitEmojiChooserEnsureEmptyResult(CyberKitEmojiChooser* chooser)
{
...
static void webkitEmojiChooserSearchChanged(CyberKitEmojiChooser* chooser)
{
    for (auto& section : chooser->priv->sections) {
...
static void webkitEmojiChooserSetupFilters(CyberKitEmojiChooser* chooser)
{
...
static void webkitEmojiChooserSetupEmojiSections(CyberKitEmojiChooser* chooser, GtkBox* emojiBox, GtkBox* buttonBox)
{
    static const struct {
    ...
    chooser->priv->populateSectionsTimer->setName("[CyberKitEmojiChooser] populate sections timer");
    chooser->priv->populateSectionsTimer->startRepeating({ });
}

static void webkitEmojiChooserInitializeEmojiMaxWidth(CyberKitEmojiChooser* chooser)
{
...
{
    CyberKitEmojiChooser* chooser = WEBKIT_EMOJI_CHOOSER(object);
...
static void webkitEmojiChooserShow(GtkWidget* widget)
{
    ...
    CyberKitEmojiChooser* chooser = WEBKIT_EMOJI_CHOOSER(widget);
...
static void webkit_emoji_chooser_class_init(CyberKitEmojiChooserClass* klass)
{
...
{
    CyberKitEmojiChooser* authDialog = WEBKIT_EMOJI_CHOOSER(g_object_new(WEBKIT_TYPE_EMOJI_CHOOSER, nullptr));
