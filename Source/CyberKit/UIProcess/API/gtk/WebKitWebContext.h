...
struct _CyberKitWebContextClass {
    ...
    gboolean (* user_message_received)               (CyberKitWebContext        *context,
...
WEBKIT_API void
webkit_web_context_send_message_to_all_extensions   (CyberKitWebContext              *context,
                                                     CyberKitUserMessage             *message);

WEBKIT_API void
webkit_web_context_set_use_system_appearance_for_scrollbars (CyberKitWebContext      *context,
                                                             gboolean               enabled);

WEBKIT_API gboolean
webkit_web_context_get_use_system_appearance_for_scrollbars (CyberKitWebContext      *context);
