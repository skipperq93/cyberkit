...
WEBKIT_DEPRECATED_FOR(webkit_context_menu_item_new_from_gaction) CyberKitContextMenuItem *
...
webkit_context_menu_item_get_action                       (CyberKitContextMenuItem  *item);
