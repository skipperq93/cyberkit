...
#include <webkit2/CyberKitInputMethodContext.h>
 ...
 *
 * Enum values used to specify the region from which to get a #CyberKitWebView
 * snapshot
 */
typedef enum {
...
struct _CyberKitWebViewClass {
    CyberKitWebViewBaseClass parent;
    ...
    GtkWidget *(* create)                      (CyberKitWebView               *web_view,
    ...
    void       (* mouse_target_changed)        (CyberKitWebView               *web_view,
                                                ...
                                                guint                        modifiers);
    gboolean   (* print)                       (CyberKitWebView               *web_view,
                                                CyberKitPrintOperation        *print_operation);
    ...
    gboolean   (* run_color_chooser)           (CyberKitWebView               *web_view,
                                                CyberKitColorChooserRequest   *request);
    gboolean   (* show_option_menu)            (CyberKitWebView               *web_view,
                                                GdkRectangle                *rectangle,
                                                CyberKitOptionMenu            *menu);
...
WEBKIT_API GtkWidget *
webkit_web_view_new_with_context                     (CyberKitWebContext          *context);

WEBKIT_API GtkWidget *
webkit_web_view_new_with_settings                    (CyberKitSettings            *settings);

WEBKIT_API GtkWidget *
webkit_web_view_new_with_related_view                (CyberKitWebView             *web_view);

WEBKIT_API GtkWidget *
webkit_web_view_new_with_user_content_manager        (CyberKitUserContentManager  *user_content_manager);
...
WEBKIT_API void
webkit_web_view_set_is_muted                         (CyberKitWebView             *web_view,
                                                      gboolean                   muted);

WEBKIT_API gboolean
webkit_web_view_get_is_muted                         (CyberKitWebView             *web_view);
...
webkit_web_view_get_favicon                          (CyberKitWebView             *web_view);
...
webkit_web_view_get_javascript_global_context        (CyberKitWebView             *web_view);
...
WEBKIT_API CyberKitWebInspector *
webkit_web_view_get_inspector                        (CyberKitWebView             *web_view);
...
webkit_web_view_get_tls_info                         (CyberKitWebView             *web_view,
                                                      ...
                                                      GTlsCertificateFlags      *errors);
WEBKIT_API void
webkit_web_view_get_snapshot                         (CyberKitWebView             *web_view,
                                                      CyberKitSnapshotRegion       region,
                                                      CyberKitSnapshotOptions      options,
                                                      GCancellable              *cancellable,
                                                      GAsyncReadyCallback        callback,
                                                      gpointer                   user_data);

WEBKIT_API cairo_surface_t *
webkit_web_view_get_snapshot_finish                  (CyberKitWebView             *web_view,
                                                      GAsyncResult              *result,
                                                      GError                   **error);
...
WEBKIT_API CyberKitWebsitePolicies *
webkit_web_view_get_website_policies                 (CyberKitWebView             *web_view);
