...
public:
    ...
    void didPostMessage(WebPageProxy& page, const FrameInfoData&, CyberCore::SerializedScriptValue& serializedScriptValue) override
    {
...
{
    Vector<CyberKitWebView*, 4> webViewsToRemove;
    for (auto* webView : m_webViews) {
