...
struct _CyberKitWebViewBaseAccessiblePrivate {
    GtkWidget* widget;
};

WEBKIT_DEFINE_TYPE(CyberKitWebViewBaseAccessible, webkit_web_view_base_accessible, ATK_TYPE_SOCKET)

static void webkitWebViewBaseAccessibleWidgetDestroyed(GtkWidget*, CyberKitWebViewBaseAccessible* accessible)
{
...
static void webkitWebViewBaseAccessibleInitialize(AtkObject* atkObject, gpointer data)
{
    ...
    if (data && GTK_IS_WIDGET(data)) {
        CyberKitWebViewBaseAccessible* accessible = WEBKIT_WEB_VIEW_BASE_ACCESSIBLE(atkObject);
...
static void webkit_web_view_base_accessible_class_init(CyberKitWebViewBaseAccessibleClass* klass)
{
...
CyberKitWebViewBaseAccessible* webkitWebViewBaseAccessibleNew(GtkWidget* widget)
{
