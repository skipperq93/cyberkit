...
#ifndef CyberKitError_h
#define CyberKitError_h
...
/**
 * CyberKitSnapshotError:
 * @WEBKIT_SNAPSHOT_ERROR_FAILED_TO_CREATE: An error occurred when creating a webpage snapshot.
 *
 * Enum values used to denote errors happening when creating snapshots of #CyberKitWebView
 */
typedef enum {
...
/**
 * CyberKitUserContentFilterError:
