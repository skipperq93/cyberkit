...
/**
 * SECTION: CyberKitPrintOperation
 * @Short_description: Controls a print operation
 * @Title: CyberKitPrintOperation
 *
...
struct _CyberKitPrintOperationPrivate {
    ~_CyberKitPrintOperationPrivate()
    {
        if (webView)
...
WEBKIT_DEFINE_TYPE(CyberKitPrintOperation, webkit_print_operation, G_TYPE_OBJECT)
...
static void webkitPrintOperationConstructed(GObject* object)
{
    ...
    CyberKitPrintOperationPrivate* priv = WEBKIT_PRINT_OPERATION(object)->priv;
...
static void drawPagesForPrintingCompleted(API::Error* wkPrintError, CyberKitPrintOperation* printOperation)
{
    ...
    const CyberCore::ResourceError& resourceError = wkPrintError ? wkPrintError->platformError() : CyberCore::ResourceError();
...
static void webkitPrintOperationPrintPagesForFrame(CyberKitPrintOperation* printOperation, WebFrameProxy* webFrame, GtkPrintSettings* printSettings, GtkPageSetup* pageSetup)
{
