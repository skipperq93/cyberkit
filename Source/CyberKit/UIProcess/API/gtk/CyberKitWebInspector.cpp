...
/**
 * SECTION: CyberKitWebInspector
 * @Short_description: Access to the CyberKit inspector
 * @Title: CyberKitWebInspector
 *
 ...
 * CyberKitSettings *setting = webkit_web_view_get_settings (WEBKIT_WEB_VIEW(my_webview));
...
WEBKIT_DEFINE_TYPE(CyberKitWebInspector, webkit_web_inspector, G_TYPE_OBJECT)
...
class CyberKitInspectorClient final : public WebInspectorProxyClient {
public:
...
CyberKitWebInspector* webkitWebInspectorCreate(WebInspectorProxy* webInspector)
{
    ...
    webInspector->setClient(std::make_unique<CyberKitInspectorClient>(inspector));
    return inspector;
}
 ...
 * @inspector: a #CyberKitWebInspector
 *
 * Request @inspector to be attached. The signal #CyberKitWebInspector::attach
 ...
 * @inspector: a #CyberKitWebInspector
 *
 * Request @inspector to be detached. The signal #CyberKitWebInspector::detach
