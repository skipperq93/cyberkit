...
/**
 * SECTION: CyberKitUserMediaPermissionRequest
 * @Short_description: A permission request for accessing user's audio/video devices.
 * @Title: CyberKitUserMediaPermissionRequest
...
WEBKIT_DEFINE_TYPE_WITH_CODE(
    CyberKitUserMediaPermissionRequest, webkit_user_media_permission_request, G_TYPE_OBJECT,
...
static void webkit_user_media_permission_request_class_init(CyberKitUserMediaPermissionRequestClass* klass)
{
    ...
    /**
     * CyberKitUserPermissionRequest:is-for-audio-device:
     *
    ...
    /**
     * CyberKitUserPermissionRequest:is-for-video-device:
     *
