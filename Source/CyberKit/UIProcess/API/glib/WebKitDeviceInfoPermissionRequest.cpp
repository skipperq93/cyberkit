...
/**
 * SECTION: CyberKitDeviceInfoPermissionRequest
 * @Short_description: A permission request for accessing user's audio/video devices.
 * @Title: CyberKitDeviceInfoPermissionRequest
...
WEBKIT_DEFINE_TYPE_WITH_CODE(
    CyberKitDeviceInfoPermissionRequest, webkit_device_info_permission_request, G_TYPE_OBJECT,
