...
/**
 * SECTION: CyberKitVersion
 * @Short_description: Provides the CyberKit version
 * @Title: CyberKitVersion
 *
 * Provides convenience functions returning CyberKit's major, minor and
 * micro versions of the CyberKit library your code is running
 * against. This is not necessarily the same as the
 * #WEBKIT_MAJOR_VERSION, #WEBKIT_MINOR_VERSION or
 * #WEBKIT_MICRO_VERSION, which represent the version of the CyberKit
