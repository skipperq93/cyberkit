...
/**
 * SECTION: CyberKitAutomationSession
 * @Short_description: Automation Session
 * @Title: CyberKitAutomationSession
 *
...
WEBKIT_DEFINE_TYPE(CyberKitAutomationSession, webkit_automation_session, G_TYPE_OBJECT)
...
static void webkit_automation_session_class_init(CyberKitAutomationSessionClass* sessionClass)
{
     ...
     * construct property enabled. The returned #CyberKitWebView could be an existing
