...
#if ENABLE(2022_GLIB_API)
void webkit_web_context_set_web_process_extensions_directory(CyberKitWebContext* context, const char* directory)
#else
...
#if ENABLE(2022_GLIB_API)
void webkit_web_context_set_web_process_extensions_initialization_user_data(CyberKitWebContext* context, GVariant* userData)
#else
...
GVariant* webkitWebContextInitializeWebProcessExtensions(CyberKitWebContext* context)
{
