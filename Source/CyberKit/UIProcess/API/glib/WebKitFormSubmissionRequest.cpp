...
/**
 * SECTION: CyberKitFormSubmissionRequest
 * @Short_description: Represents a form submission request
 * @Title: CyberKitFormSubmissionRequest
 *
...
WEBKIT_DEFINE_TYPE(CyberKitFormSubmissionRequest, webkit_form_submission_request, G_TYPE_OBJECT)
