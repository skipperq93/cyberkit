...
/**
 * SECTION: CyberKitWindowProperties
 * @short_description: Window properties of a #CyberKitWebView
 * @title: CyberKitWindowProperties
...
WEBKIT_DEFINE_TYPE(CyberKitWindowProperties, webkit_window_properties, G_TYPE_OBJECT)
...
static void webkit_window_properties_class_init(CyberKitWindowPropertiesClass* requestClass)
{
...
#if PLATFORM(GTK)
    /**
     * CyberKitWebWindowProperties:geometry:
     *
    ...
    /**
     * CyberKitWebWindowProperties:toolbar-visible:
     *
    ...
    /**
     * CyberKitWebWindowProperties:statusbar-visible:
     *
    ...
    /**
     * CyberKitWebWindowProperties:scrollbars-visible:
     *
    ...
    /**
     * CyberKitWebWindowProperties:menubar-visible:
     *
    ...
    /**
     * CyberKitWebWindowProperties:locationbar-visible:
     *
    ...
    g_object_class_install_property(objectClass,
                                    ...
                                    g_param_spec_boolean("locationbar-visible",
                                                         ...
                                                         paramFlags));
    /**
     * CyberKitWebWindowProperties:resizable:
     *
    ...
    /**
     * CyberKitWebWindowProperties:fullscreen:
     *
