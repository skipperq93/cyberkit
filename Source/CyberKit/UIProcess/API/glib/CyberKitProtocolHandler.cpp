...
void CyberKitProtocolHandler::handleGPU(CyberKitURISchemeRequest* request)
{
    ...
    addTableRow(versionObject, "CyberKit version"_s, makeString(webkitPortName(), ' ', WEBKIT_MAJOR_VERSION, '.', WEBKIT_MINOR_VERSION, '.', WEBKIT_MICRO_VERSION, " ("_s, BUILD_REVISION, ')'));
