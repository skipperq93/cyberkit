...
/**
 * SECTION: CyberKitGeolocationPermissionRequest
 * @Short_description: A permission request for sharing user's location
 * @Title: CyberKitGeolocationPermissionRequest
...
WEBKIT_DEFINE_TYPE_WITH_CODE(
    CyberKitGeolocationPermissionRequest, webkit_geolocation_permission_request, G_TYPE_OBJECT,
