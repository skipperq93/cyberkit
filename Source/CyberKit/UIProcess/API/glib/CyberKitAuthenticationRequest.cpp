...
CyberKitAuthenticationRequest* webkitAuthenticationRequestCreate(AuthenticationChallengeProxy* authenticationChallenge, bool privateBrowsingEnabled)
{
...
void webkit_authentication_request_authenticate(CyberKitAuthenticationRequest* request, CyberKitCredential* credential)
{
    ...
    request->priv->authenticationChallenge->listener().completeChallenge(CyberKit::AuthenticationChallengeDisposition::UseCredential, credential ? webkitCredentialGetCredential(credential) : CyberCore::Credential());
