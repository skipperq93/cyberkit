...
/**
 * SECTION: CyberKitPointerLockPermissionRequest
 * @Short_description: A permission request for locking the pointer
 * @Title: CyberKitPointerLockPermissionRequest
...
WEBKIT_DEFINE_TYPE_WITH_CODE(
    CyberKitPointerLockPermissionRequest, webkit_pointer_lock_permission_request, G_TYPE_OBJECT,
