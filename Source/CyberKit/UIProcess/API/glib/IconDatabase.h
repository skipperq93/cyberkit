...
public:
    ...
    void loadIconForPageURL(const String&, AllowDatabaseWrite, CompletionHandler<void(CyberCore::NativeImagePtr&&)>&&);
...
private:
    ...
    HashMap<String, std::pair<CyberCore::NativeImagePtr, MonotonicTime>> m_loadedIcons;
