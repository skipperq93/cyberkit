...
class CyberKitNotificationProvider {
public:
...
private:
    ...
    static void notificationCloseCallback(CyberKitNotification*, CyberKitNotificationProvider*);
    static void notificationClickedCallback(CyberKitNotification*, CyberKitNotificationProvider*);
    ...
    HashMap<uint64_t, GRefPtr<CyberKitNotification>> m_notifications;
};
