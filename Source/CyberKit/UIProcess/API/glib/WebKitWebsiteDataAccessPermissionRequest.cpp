...
/**
 * SECTION: CyberKitWebsiteDataAccessPermissionRequest
 * @Short_description: A permission request for accessing website data from third-party domains
 * @Title: CyberKitWebsiteDataAccessPermissionRequest
...
WEBKIT_DEFINE_TYPE_WITH_CODE(
    CyberKitWebsiteDataAccessPermissionRequest, webkit_website_data_access_permission_request, G_TYPE_OBJECT,
