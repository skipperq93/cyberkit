...
/**
 * SECTION: CyberKitInstallMissingMediaPluginsPermissionRequest
 * @Short_description: A permission request for installing missing media plugins
 * @Title: CyberKitInstallMissingMediaPluginsPermissionRequest
 * @See_also: #CyberKitPermissionRequest, #CyberKitWebView
 *
 * CyberKitInstallMissingMediaPluginsPermissionRequest represents a request for
 * permission to decide whether CyberKit should try to start a helper application to
 ...
 *
 * When a CyberKitInstallMissingMediaPluginsPermissionRequest is not handled by the user,
...
static void webkitInstallMissingMediaPluginsPermissionRequestAllow(CyberKitPermissionRequest* request)
{
    ASSERT(WEBKIT_IS_INSTALL_MISSING_MEDIA_PLUGINS_PERMISSION_REQUEST(request));

    CyberKitInstallMissingMediaPluginsPermissionRequestPrivate* priv = WEBKIT_INSTALL_MISSING_MEDIA_PLUGINS_PERMISSION_REQUEST(request)->priv;
...
static void webkitInstallMissingMediaPluginsPermissionRequestDeny(CyberKitPermissionRequest* request)
{
    ASSERT(WEBKIT_IS_INSTALL_MISSING_MEDIA_PLUGINS_PERMISSION_REQUEST(request));
...
static void webkit_install_missing_media_plugins_permission_request_class_init(CyberKitInstallMissingMediaPluginsPermissionRequestClass* klass)
{
...
#if ENABLE(VIDEO)
CyberKitInstallMissingMediaPluginsPermissionRequest* webkitInstallMissingMediaPluginsPermissionRequestCreate(InstallMissingMediaPluginsPermissionRequest& request)
{
    CyberKitInstallMissingMediaPluginsPermissionRequest* permissionRequest = WEBKIT_INSTALL_MISSING_MEDIA_PLUGINS_PERMISSION_REQUEST(g_object_new(WEBKIT_TYPE_INSTALL_MISSING_MEDIA_PLUGINS_PERMISSION_REQUEST, nullptr));
 ...
 * Since: 2.10
 */
const char* webkit_install_missing_media_plugins_permission_request_get_description(CyberKitInstallMissingMediaPluginsPermissionRequest* request)
{
