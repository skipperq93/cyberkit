...
/**
 * SECTION: CyberKitInputMethodContext
 * @Short_description: Base class for input method contexts
 * @Title: CyberKitInputMethodContext
 ...
 * @underlines: (out) (transfer full) (nullable) (element-type CyberKit2.InputMethodUnderline): location to store the underlines as a #GList of #CyberKitInputMethodUnderline
 * @cursor_offset: (out) (nullable): location to store the position of cursor in preedit string
 *
 * Get the current preedit string for the @context, and a list of CyberKitInputMethodUnderline to apply to the string.
