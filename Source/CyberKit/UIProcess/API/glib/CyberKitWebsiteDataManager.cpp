 ...
 *
 * A CyberKitWebsiteDataManager can be ephemeral, in which case all the directory configuration
...
static void webkit_website_data_manager_class_init(CyberKitWebsiteDataManagerClass* findClass)
{
    ...
    /**
     * CyberKitWebsiteDataManager:origin-storage-ratio:
     *
     ...
     * means CyberKit will use the default quota (1 GiB).
     *
     * Since: 2.42
     */
    g_object_class_install_property(
    ...
    /**
     * CyberKitWebsiteDataManager:total-storage-ratio:
     *
