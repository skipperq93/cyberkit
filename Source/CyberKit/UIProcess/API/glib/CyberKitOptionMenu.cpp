...
/**
 * SECTION: CyberKitOptionMenu
 * @Short_description:
 * @Title: CyberKitOptionMenu
 *
 * CyberKitOptionMenu represents the dropdown menu of a select element in a #CyberKitWebView.
 *
...
WEBKIT_DEFINE_TYPE(CyberKitOptionMenu, webkit_option_menu, G_TYPE_OBJECT)
 ...
 * @index: the index of the item
 *
 * Selects the #CyberKitOptionMenuItem at @index in @menu. Selecting an item changes the
 ...
 * @index: the index of the item
 *
 * Activates the #CyberKitOptionMenuItem at @index in @menu. Activating an item changes the value
 ...
 * @menu: a #CyberKitOptionMenu
 *
 * Request to close a #CyberKitOptionMenu. This emits CyberKitOptionMenu::close signal.
