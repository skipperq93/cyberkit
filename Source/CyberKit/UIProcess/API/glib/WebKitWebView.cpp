 ...
 * @Short_description: The central class of the CyberKit2GTK+ API
 * @Title: CyberKitWebView
 *
 * #CyberKitWebView is the central class of the CyberKit2GTK+ API. It is
 * responsible for managing the drawing of the content and forwarding
 * of events. You can load any URI into the #CyberKitWebView or a data
 * string. With #CyberKitSettings you can control various aspects of the
 * rendering and loading of the content.
 *
 * Note that #CyberKitWebView is scrollable by itself, so you don't need
...
void webkitWebViewMouseTargetChanged(CyberKitWebView* webView, const WebHitTestResultData& hitTestResult, WebEvent::Modifiers modifiers)
{
#if PLATFORM(GTK)
