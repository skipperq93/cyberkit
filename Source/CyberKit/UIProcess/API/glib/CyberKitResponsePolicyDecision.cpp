...
/**
 * SECTION: CyberKitResponsePolicyDecision
 * @Short_description: A policy decision for resource responses
 * @Title: CyberKitResponsePolicyDecision
...
WEBKIT_DEFINE_TYPE(CyberKitResponsePolicyDecision, webkit_response_policy_decision, WEBKIT_TYPE_POLICY_DECISION)
