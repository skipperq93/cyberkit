...
void webkitEditorStateChanged(CyberKitEditorState* editorState, const EditorState& newState)
{
    ...
    if (postLayoutData.typingAttributes.contains(CyberKit::TypingAttribute::Bold))
        typingAttributes |= WEBKIT_EDITOR_TYPING_ATTRIBUTE_BOLD;
    if (postLayoutData.typingAttributes.contains(CyberKit::TypingAttribute::Italics))
        typingAttributes |= WEBKIT_EDITOR_TYPING_ATTRIBUTE_ITALIC;
    if (postLayoutData.typingAttributes.contains(CyberKit::TypingAttribute::Underline))
        typingAttributes |= WEBKIT_EDITOR_TYPING_ATTRIBUTE_UNDERLINE;
    if (postLayoutData.typingAttributes.contains(CyberKit::TypingAttribute::StrikeThrough))
