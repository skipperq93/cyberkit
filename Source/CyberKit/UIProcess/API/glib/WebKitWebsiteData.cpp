...
/**
 * SECTION: CyberKitWebsiteData
 * @Short_description: Website data
 * @Title: CyberKitWebsiteData
 ...
 * @website_data: a #CyberKitWebsiteData
 *
 * Gets the name of #CyberKitWebsiteData. This is the website name, normally represented by
 ...
 * @website_data: a #CyberKitWebsiteData
 *
 * Gets the types of data stored in the client for a #CyberKitWebsiteData. These are the
