...
/**
 * SECTION: CyberKitBackForwardListItem
 * @Short_description: One item of the #CyberKitBackForwardList
 * @Title: CyberKitBackForwardListItem
...
WEBKIT_DEFINE_TYPE(CyberKitBackForwardListItem, webkit_back_forward_list_item, G_TYPE_INITIALLY_UNOWNED)
