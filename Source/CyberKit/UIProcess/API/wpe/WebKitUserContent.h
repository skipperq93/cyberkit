...
#ifndef CyberKitUserContent_h
#define CyberKitUserContent_h
...
/**
 * CyberKitUserContentInjectedFrames:
...
typedef struct _CyberKitUserStyleSheet CyberKitUserStyleSheet;

WEBKIT_API GType
webkit_user_style_sheet_get_type      (void);

WEBKIT_API CyberKitUserStyleSheet *
webkit_user_style_sheet_ref           (CyberKitUserStyleSheet           *user_style_sheet);

WEBKIT_API void
webkit_user_style_sheet_unref         (CyberKitUserStyleSheet           *user_style_sheet);

WEBKIT_API CyberKitUserStyleSheet *
webkit_user_style_sheet_new           (const gchar                    *source,
                                       CyberKitUserContentInjectedFrames injected_frames,
                                       CyberKitUserStyleLevel            level,
...
/**
 * CyberKitUserScriptInjectionTime:
...
typedef struct _CyberKitUserScript CyberKitUserScript;

WEBKIT_API GType
webkit_user_script_get_type      (void);

WEBKIT_API CyberKitUserScript *
webkit_user_script_ref           (CyberKitUserScript               *user_script);

WEBKIT_API void
webkit_user_script_unref         (CyberKitUserScript               *user_script);

WEBKIT_API CyberKitUserScript *
webkit_user_script_new           (const gchar                    *source,
                                  CyberKitUserContentInjectedFrames injected_frames,
                                  CyberKitUserScriptInjectionTime   injection_time,
                                  const gchar* const             *allow_list,
                                  const gchar* const             *block_list);
...
webkit_user_content_filter_get_identifier (CyberKitUserContentFilter     *user_content_filter);

WEBKIT_API CyberKitUserContentFilter *
webkit_user_content_filter_ref            (CyberKitUserContentFilter     *user_content_filter);

WEBKIT_API void
webkit_user_content_filter_unref          (CyberKitUserContentFilter     *user_content_filter);
