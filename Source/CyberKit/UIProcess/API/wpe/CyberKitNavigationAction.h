...
#ifndef CyberKitNavigationAction_h
#define CyberKitNavigationAction_h
...
typedef struct _CyberKitNavigationAction CyberKitNavigationAction;
...
webkit_navigation_action_copy                (CyberKitNavigationAction *navigation);

WEBKIT_API void
webkit_navigation_action_free                (CyberKitNavigationAction *navigation);

WEBKIT_API CyberKitNavigationType
webkit_navigation_action_get_navigation_type (CyberKitNavigationAction *navigation);

WEBKIT_API guint
webkit_navigation_action_get_mouse_button    (CyberKitNavigationAction *navigation);

WEBKIT_API guint
webkit_navigation_action_get_modifiers       (CyberKitNavigationAction *navigation);

WEBKIT_API CyberKitURIRequest *
webkit_navigation_action_get_request         (CyberKitNavigationAction *navigation);

WEBKIT_API gboolean
webkit_navigation_action_is_user_gesture     (CyberKitNavigationAction *navigation);

WEBKIT_API gboolean
webkit_navigation_action_is_redirect         (CyberKitNavigationAction *navigation);
