...
/**
 * webkit_web_view_new:
 * @backend: (transfer full): a #CyberKitWebViewBackend
 *
 ...
 *
 * Returns: The newly created #CyberKitWebView
 */
 ...
 *
 * Returns: (transfer full): The newly created #CyberKitWebView
 *
 * Since: 2.4
 */
...
/**
 * webkit_web_view_new_with_settings:
 * @backend: (nullable) (transfer full): a #CyberKitWebViewBackend, or %NULL to use the default
 ...
 * @backgroundColor: a #CyberKitColor
 *
 ...
 * @web_view: a #CyberKitWebView
 * @rgba: (out): a #CyberKitColor to fill in with the background color
 *
...
void webkit_web_view_get_background_color(CyberKitWebView* webView, CyberKitColor* color)
{
    ...
    webkitColorFillFromCyberCoreColor(webCoreColor.valueOr(CyberCore::Color::white), color);
}
