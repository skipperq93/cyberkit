...
#ifndef CyberKitCredential_h
#define CyberKitCredential_h
...
typedef struct _CyberKitCredential CyberKitCredential;

/**
 * CyberKitCredentialPersistence:
...
webkit_credential_new                  (const gchar                 *username,
                                        ...
                                        CyberKitCredentialPersistence  persistence);

WEBKIT_API CyberKitCredential *
webkit_credential_copy                 (CyberKitCredential            *credential);

WEBKIT_API void
webkit_credential_free                 (CyberKitCredential            *credential);

WEBKIT_API const gchar *
webkit_credential_get_username         (CyberKitCredential            *credential);

WEBKIT_API const gchar *
webkit_credential_get_password         (CyberKitCredential            *credential);

WEBKIT_API gboolean
webkit_credential_has_password         (CyberKitCredential            *credential);

WEBKIT_API CyberKitCredentialPersistence
webkit_credential_get_persistence      (CyberKitCredential            *credential);
