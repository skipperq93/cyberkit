...
struct _CyberKitInputMethodContextClass {
    ...
    void     (* committed)          (CyberKitInputMethodContext        *context,
                                     const char                      *text);
    void     (* delete_surrounding) (CyberKitInputMethodContext        *context,
                                     int                              offset,
                                     guint                            n_chars);
    ...
    void     (* notify_cursor_area) (CyberKitInputMethodContext        *context,
                                     ...
                                     int                              width,
                                     int                              height);
    void     (* notify_surrounding) (CyberKitInputMethodContext        *context,
                                     const gchar                     *text,
                                     guint                            length,
                                     guint                            cursor_index,
...
WEBKIT_API void
webkit_input_method_context_notify_surrounding (CyberKitInputMethodContext        *context,
                                                const gchar                     *text,
                                                int                              length,
                                                guint                            cursor_index,
                                                guint                            selection_index);
...
WEBKIT_API CyberKitInputPurpose
webkit_input_method_context_get_input_purpose  (CyberKitInputMethodContext        *context);

WEBKIT_API void
webkit_input_method_context_set_input_purpose  (CyberKitInputMethodContext        *context,
                                                CyberKitInputPurpose               purpose);

WEBKIT_API CyberKitInputHints
webkit_input_method_context_get_input_hints    (CyberKitInputMethodContext        *context);

WEBKIT_API void
webkit_input_method_context_set_input_hints    (CyberKitInputMethodContext        *context,
