...
#ifndef CyberKitEditingCommands_h
#define CyberKitEditingCommands_h
 ...
 * a #CyberKitWebView to the clipboard and deletes the selected content.
 ...
 * possible to cut to the clipboard when the #CyberKitWebView content is
 ...
 * to paste from the clipboard when the #CyberKitWebView content is editable
 ...
 * clipboard to a #CyberKitWebView, with formatting removed.
 * You can check whether it's possible to execute the command with
 * webkit_web_view_can_execute_editing_command(). In general it's possible
 * to paste from the clipboard when the #CyberKitWebView content is editable
 * and clipboard is not empty.
 ...
 * #CyberKitWebView content is editable or not. You can still check it
 ...
 *
 * The undo command. Undoes the last editing command in a #CyberKitWebView.
 * You can check whether it's possible to execute the command with
