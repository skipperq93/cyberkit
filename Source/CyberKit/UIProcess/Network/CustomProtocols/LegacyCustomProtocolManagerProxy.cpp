...
void LegacyCustomProtocolManagerProxy::startLoading(uint64_t customProtocolID, const CyberCore::ResourceRequest& request)
{
...
void LegacyCustomProtocolManagerProxy::wasRedirectedToRequest(uint64_t customProtocolID, const CyberCore::ResourceRequest& request, const CyberCore::ResourceResponse& redirectResponse)
{
...
void LegacyCustomProtocolManagerProxy::didReceiveResponse(uint64_t customProtocolID, const CyberCore::ResourceResponse& response, uint32_t cacheStoragePolicy)
{
...
void LegacyCustomProtocolManagerProxy::didFailWithError(uint64_t customProtocolID, const CyberCore::ResourceError& error)
{
