...
void LegacyCustomProtocolManagerProxy::didReceiveResponse(LegacyCustomProtocolID customProtocolID, const CyberCore::ResourceResponse& response, uint32_t cacheStoragePolicy)
{
