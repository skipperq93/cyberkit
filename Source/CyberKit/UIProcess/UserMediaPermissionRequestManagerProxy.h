...
public:
    ...
    void requestUserMediaPermissionForFrame(uint64_t userMediaID, uint64_t frameID, Ref<CyberCore::SecurityOrigin>&&  userMediaDocumentOrigin, Ref<CyberCore::SecurityOrigin>&& topLevelDocumentOrigin, CyberCore::MediaStreamRequest&&);
...
private:
    ...
    void getUserMediaPermissionInfo(uint64_t frameID, Ref<CyberCore::SecurityOrigin>&& userMediaDocumentOrigin, Ref<CyberCore::SecurityOrigin>&& topLevelDocumentOrigin, CompletionHandler<void(PermissionInfo)>&&);
