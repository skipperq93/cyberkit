...
public:
    ...
    void enumerateMediaDevicesForFrame(CyberCore::FrameIdentifier, Ref<CyberCore::SecurityOrigin>&& userMediaDocumentOrigin, Ref<CyberCore::SecurityOrigin>&& topLevelDocumentOrigin, CompletionHandler<void(const Vector<CyberCore::CaptureDeviceWithCapabilities>&, CyberCore::MediaDeviceHashSalts&&)>&&);
...
private:
    ...
    void computeFilteredDeviceList(bool revealIdsAndLabels, CompletionHandler<void(Vector<CyberCore::CaptureDeviceWithCapabilities>&&)>&&);
    void platformGetMediaStreamDevices(bool revealIdsAndLabels, CompletionHandler<void(Vector<CyberCore::CaptureDeviceWithCapabilities>&&)>&&);
