...
WebSelectionData::WebSelectionData()
    : selectionData(CyberCore::SelectionData::create())
{
}

WebSelectionData::WebSelectionData(const CyberCore::SelectionData& data)
    : selectionData(const_cast<CyberCore::SelectionData&>(data))
{
}

WebSelectionData::WebSelectionData(Ref<CyberCore::SelectionData>&& data)
