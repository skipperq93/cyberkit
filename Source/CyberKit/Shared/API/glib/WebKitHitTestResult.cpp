...
/**
 * SECTION: CyberKitHitTestResult
 * @Short_description: Result of a Hit Test
 * @Title: CyberKitHitTestResult
...
WEBKIT_DEFINE_TYPE(CyberKitHitTestResult, webkit_hit_test_result, G_TYPE_OBJECT)
...
static void webkit_hit_test_result_class_init(CyberKitHitTestResultClass* hitTestResultClass)
{
    ...
    g_object_class_install_property(objectClass,
                                    ...
                                    g_param_spec_uint("context",
                                                      _("Context"),
                                                      _("Flags with the context of the CyberKitHitTestResult"),
                                                      0, G_MAXUINT, 0,
                                                      paramFlags));
