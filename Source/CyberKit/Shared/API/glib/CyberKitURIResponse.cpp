...
/**
 * SECTION: CyberKitURIResponse
 * @Short_description: Represents a URI response
 * @Title: CyberKitURIResponse
 *
...
WEBKIT_DEFINE_TYPE(CyberKitURIResponse, webkit_uri_response, G_TYPE_OBJECT)
 ...
 *
 * Returns: the uri of the #CyberKitURIResponse
 */
 ...
 * @response: a #CyberKitURIResponse
 *
 * Get the expected content length of the #CyberKitURIResponse. It can
 ...
 * @response: a #CyberKitURIResponse
 *
 * Returns: the MIME type of the #CyberKitURIResponse
 */
