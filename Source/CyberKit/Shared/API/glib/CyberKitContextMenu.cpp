...
/**
 * SECTION: CyberKitContextMenu
 * @Short_description: Represents the context menu in a #CyberKitWebView
 * @Title: CyberKitContextMenu
 *
...
WEBKIT_DEFINE_TYPE(CyberKitContextMenu, webkit_context_menu, G_TYPE_OBJECT)
