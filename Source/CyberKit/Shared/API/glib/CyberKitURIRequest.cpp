...
/**
 * SECTION: CyberKitURIRequest
 * @Short_description: Represents a URI request
 * @Title: CyberKitURIRequest
 *
...
WEBKIT_DEFINE_TYPE(CyberKitURIRequest, webkit_uri_request, G_TYPE_OBJECT)
 ...
 *
 * Returns: the uri of the #CyberKitURIRequest
 */
