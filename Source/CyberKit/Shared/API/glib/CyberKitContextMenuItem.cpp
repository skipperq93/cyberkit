...
/**
 * SECTION: CyberKitContextMenuItem
 * @Short_description: One item of the #CyberKitContextMenu
 * @Title: CyberKitContextMenuItem
 *
...
WEBKIT_DEFINE_TYPE(CyberKitContextMenuItem, webkit_context_menu_item, G_TYPE_INITIALLY_UNOWNED)
 ...
 *
 * Creates a new #CyberKitContextMenuItem for the given @action and @label. On activation
 ...
 * @item: a #CyberKitContextMenuItem
 *
 * Gets the #CyberKitContextMenuAction of @item. If the #CyberKitContextMenuItem was not
