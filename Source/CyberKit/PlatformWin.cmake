...
list(APPEND CyberKit_SOURCES
    ...
    WebProcess/CyberCoreSupport/win/WebContextMenuClientWin.cpp
...
# DerivedSources/CyberScriptCore/inspector/InspectorBackendCommands.js is
...
add_custom_command(
    ...
    DEPENDS ${CyberScriptCore_DERIVED_SOURCES_DIR}/inspector/InspectorBackendCommands.js
    COMMAND cp ${CyberScriptCore_DERIVED_SOURCES_DIR}/inspector/InspectorBackendCommands.js ${DERIVED_SOURCES_WEBINSPECTORUI_DIR}/UserInterface/Protocol/InspectorBackendCommands.js
)
...
WEBKIT_MAKE_FORWARDING_HEADERS(CyberKit
    TARGET_NAME CyberKitFrameworkHeaders
    DESTINATION ${CyberKit_FRAMEWORK_HEADERS_DIR}/CyberKit
    FILES ${CyberKit_PUBLIC_FRAMEWORK_HEADERS}
    FLATTENED
)
