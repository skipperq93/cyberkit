...
SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::ToValueTypeName) \
    static bool isType(const CyberCore::InlineBox& box) { return box.predicate; } \
SPECIALIZE_TYPE_TRAITS_END()

#if ENABLE(TREE_DEBUGGING)
// Outside the CyberCore namespace for ease of invocation from the debugger.
void showNodeTree(const CyberCore::InlineBox*);
void showLineTree(const CyberCore::InlineBox*);
#endif
