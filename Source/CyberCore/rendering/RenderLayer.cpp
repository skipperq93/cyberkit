...
void showLayerTree(const CyberCore::RenderLayer* layer)
{
    ...
    WTF::String output = externalRepresentation(&layer->renderer().frame(), CyberCore::RenderAsTextShowAllLayers | CyberCore::RenderAsTextShowLayerNesting | CyberCore::RenderAsTextShowCompositedLayers | CyberCore::RenderAsTextShowAddresses | CyberCore::RenderAsTextShowIDAndClass | CyberCore::RenderAsTextDontUpdateLayout | CyberCore::RenderAsTextShowLayoutState | CyberCore::RenderAsTextShowOverflow | CyberCore::RenderAsTextShowSVGGeometry | CyberCore::RenderAsTextShowLayerFragments);
    fprintf(stderr, "\n%s\n", output.utf8().data());
}
