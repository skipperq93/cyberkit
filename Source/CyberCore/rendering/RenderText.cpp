...
{
    if (text().is8Bit())
        return CyberCore::containsOnlyCollapsibleWhitespace(text().characters8(), text().length(), style());
    return CyberCore::containsOnlyCollapsibleWhitespace(text().characters16(), text().length(), style());
}
