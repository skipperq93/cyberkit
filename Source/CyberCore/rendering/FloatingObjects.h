...
template<> struct ValueToString<CyberCore::FloatingObject*> {
    static String string(const CyberCore::FloatingObject* floatingObject) { return floatingObject->debugString(); }
};
