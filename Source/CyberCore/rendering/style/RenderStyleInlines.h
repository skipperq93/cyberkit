...
inline bool RenderStyle::isFlippedBlocksWritingMode() const { return CyberCore::isFlippedWritingMode(writingMode()); }
inline bool RenderStyle::isFlippedLinesWritingMode() const { return CyberCore::isFlippedLinesWritingMode(writingMode()); }
...
inline bool RenderStyle::isHorizontalWritingMode() const { return CyberCore::isHorizontalWritingMode(writingMode()); }
...
inline bool RenderStyle::isVerticalWritingMode() const { return CyberCore::isVerticalWritingMode(writingMode()); }
