...
WTF::TextStream& operator<<(WTF::TextStream&, CyberCore::Overflow);
...
namespace WTF {
template<> struct EnumTraits<CyberCore::ScrollSnapStop> {
    using values = EnumValues<
        CyberCore::ScrollSnapStop,
        CyberCore::ScrollSnapStop::Normal,
        CyberCore::ScrollSnapStop::Always
    >;
};

template<> struct EnumTraits<CyberCore::ListStyleType> {
    using values = EnumValues<
        CyberCore::ListStyleType,
        CyberCore::ListStyleType::Disc,
        CyberCore::ListStyleType::Circle,
        CyberCore::ListStyleType::Square,
        CyberCore::ListStyleType::Decimal,
        CyberCore::ListStyleType::DecimalLeadingZero,
        CyberCore::ListStyleType::ArabicIndic,
        CyberCore::ListStyleType::Binary,
        CyberCore::ListStyleType::Bengali,
        CyberCore::ListStyleType::Cambodian,
        CyberCore::ListStyleType::Khmer,
        CyberCore::ListStyleType::Devanagari,
        CyberCore::ListStyleType::Gujarati,
        CyberCore::ListStyleType::Gurmukhi,
        CyberCore::ListStyleType::Kannada,
        CyberCore::ListStyleType::LowerHexadecimal,
        CyberCore::ListStyleType::Lao,
        CyberCore::ListStyleType::Malayalam,
        CyberCore::ListStyleType::Mongolian,
        CyberCore::ListStyleType::Myanmar,
        CyberCore::ListStyleType::Octal,
        CyberCore::ListStyleType::Oriya,
        CyberCore::ListStyleType::Persian,
        CyberCore::ListStyleType::Urdu,
        CyberCore::ListStyleType::Telugu,
        CyberCore::ListStyleType::Tibetan,
        CyberCore::ListStyleType::Thai,
        CyberCore::ListStyleType::UpperHexadecimal,
        CyberCore::ListStyleType::LowerRoman,
        CyberCore::ListStyleType::UpperRoman,
        CyberCore::ListStyleType::LowerGreek,
        CyberCore::ListStyleType::LowerAlpha,
        CyberCore::ListStyleType::LowerLatin,
        CyberCore::ListStyleType::UpperAlpha,
        CyberCore::ListStyleType::UpperLatin,
        CyberCore::ListStyleType::Afar,
        CyberCore::ListStyleType::EthiopicHalehameAaEt,
        CyberCore::ListStyleType::EthiopicHalehameAaEr,
        CyberCore::ListStyleType::Amharic,
        CyberCore::ListStyleType::EthiopicHalehameAmEt,
        CyberCore::ListStyleType::AmharicAbegede,
        CyberCore::ListStyleType::EthiopicAbegedeAmEt,
        CyberCore::ListStyleType::CJKEarthlyBranch,
        CyberCore::ListStyleType::CJKHeavenlyStem,
        CyberCore::ListStyleType::Ethiopic,
        CyberCore::ListStyleType::EthiopicHalehameGez,
        CyberCore::ListStyleType::EthiopicAbegede,
        CyberCore::ListStyleType::EthiopicAbegedeGez,
        CyberCore::ListStyleType::HangulConsonant,
        CyberCore::ListStyleType::Hangul,
        CyberCore::ListStyleType::LowerNorwegian,
        CyberCore::ListStyleType::Oromo,
        CyberCore::ListStyleType::EthiopicHalehameOmEt,
        CyberCore::ListStyleType::Sidama,
        CyberCore::ListStyleType::EthiopicHalehameSidEt,
        CyberCore::ListStyleType::Somali,
        CyberCore::ListStyleType::EthiopicHalehameSoEt,
        CyberCore::ListStyleType::Tigre,
        CyberCore::ListStyleType::EthiopicHalehameTig,
        CyberCore::ListStyleType::TigrinyaEr,
        CyberCore::ListStyleType::EthiopicHalehameTiEr,
        CyberCore::ListStyleType::TigrinyaErAbegede,
        CyberCore::ListStyleType::EthiopicAbegedeTiEr,
        CyberCore::ListStyleType::TigrinyaEt,
        CyberCore::ListStyleType::EthiopicHalehameTiEt,
        CyberCore::ListStyleType::TigrinyaEtAbegede,
        CyberCore::ListStyleType::EthiopicAbegedeTiEt,
        CyberCore::ListStyleType::UpperGreek,
        CyberCore::ListStyleType::UpperNorwegian,
        CyberCore::ListStyleType::Asterisks,
        CyberCore::ListStyleType::Footnotes,
        CyberCore::ListStyleType::Hebrew,
        CyberCore::ListStyleType::Armenian,
        CyberCore::ListStyleType::LowerArmenian,
        CyberCore::ListStyleType::UpperArmenian,
        CyberCore::ListStyleType::Georgian,
        CyberCore::ListStyleType::CJKIdeographic,
        CyberCore::ListStyleType::Hiragana,
        CyberCore::ListStyleType::Katakana,
        CyberCore::ListStyleType::HiraganaIroha,
        CyberCore::ListStyleType::KatakanaIroha,
        CyberCore::ListStyleType::CJKDecimal,
        CyberCore::ListStyleType::Tamil,
        CyberCore::ListStyleType::DisclosureOpen,
        CyberCore::ListStyleType::DisclosureClosed,
        CyberCore::ListStyleType::JapaneseInformal,
        CyberCore::ListStyleType::JapaneseFormal,
        CyberCore::ListStyleType::KoreanHangulFormal,
        CyberCore::ListStyleType::KoreanHanjaInformal,
        CyberCore::ListStyleType::KoreanHanjaFormal,
        CyberCore::ListStyleType::SimplifiedChineseInformal,
        CyberCore::ListStyleType::SimplifiedChineseFormal,
        CyberCore::ListStyleType::TraditionalChineseInformal,
        CyberCore::ListStyleType::TraditionalChineseFormal,
        CyberCore::ListStyleType::EthiopicNumeric,
        CyberCore::ListStyleType::String,
        CyberCore::ListStyleType::None
    >;
};
