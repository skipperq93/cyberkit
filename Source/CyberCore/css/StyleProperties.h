...
SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::StyleProperties)
    static bool isType(const CyberCore::StylePropertiesBase& set) { return set.type() != CyberCore::DeferredPropertiesType; }
SPECIALIZE_TYPE_TRAITS_END()

SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::MutableStyleProperties)
    static bool isType(const CyberCore::StylePropertiesBase& set) { return set.type() == CyberCore::MutablePropertiesType; }
SPECIALIZE_TYPE_TRAITS_END()

SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::ImmutableStyleProperties)
    static bool isType(const CyberCore::StylePropertiesBase& set) { return set.type() == CyberCore::ImmutablePropertiesType; }
SPECIALIZE_TYPE_TRAITS_END()

SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::DeferredStyleProperties)
    static bool isType(const CyberCore::StylePropertiesBase& set) { return set.type() == CyberCore::DeferredPropertiesType; }
SPECIALIZE_TYPE_TRAITS_END()
