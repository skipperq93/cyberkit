...
my %styleBuilderOptions = (
    "animatable" => 1, # Defined in Source/CyberCore/style/StyleBuilderConverter.h
    "auto-functions" => 1,
...
namespace WTF {
template<> struct DefaultHash<CyberCore::CSSPropertyID> { typedef IntHash<unsigned> Hash; };
template<> struct HashTraits<CyberCore::CSSPropertyID> : GenericHashTraits<CyberCore::CSSPropertyID> {
    static const bool emptyValueIsZero = true;
    static void constructDeletedValue(CyberCore::CSSPropertyID& slot) { slot = static_cast<CyberCore::CSSPropertyID>(CyberCore::lastCSSProperty + 1); }
    static bool isDeletedValue(CyberCore::CSSPropertyID value) { return value == (CyberCore::lastCSSProperty + 1); }
};
} // namespace WTF
