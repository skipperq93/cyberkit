...
WEBKIT_DEFINE_TYPE_WITH_CODE(
    CyberKitAccessibleHyperlink, webkit_accessible_hyperlink, ATK_TYPE_HYPERLINK,
...
static gboolean webkitAccessibleHyperlinkActionDoAction(AtkAction* action, gint)
{
    ...
    returnValIfCyberKitAccessibleIsInvalid(accessibleHyperlink->priv->hyperlinkImpl, FALSE);
...
{
    auto* accessibleHyperlink = WEBKIT_ACCESSIBLE_HYPERLINK(action);
    returnValIfCyberKitAccessibleIsInvalid(accessibleHyperlink->priv->hyperlinkImpl, 0);
...
{
    auto* accessibleHyperlink = WEBKIT_ACCESSIBLE_HYPERLINK(action);
    returnValIfCyberKitAccessibleIsInvalid(accessibleHyperlink->priv->hyperlinkImpl, nullptr);
...
static void webkit_accessible_hyperlink_class_init(CyberKitAccessibleHyperlinkClass* klass)
{
...
CyberKitAccessibleHyperlink* webkitAccessibleHyperlinkGetOrCreate(AtkHyperlinkImpl* hyperlinkImpl)
{
