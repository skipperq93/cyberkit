...
#include "config.h"
#include "CyberKitAccessibleWrapperAtk.h"
...
#define WEBKIT_ACCESSIBLE_GET_PRIVATE(obj) (G_TYPE_INSTANCE_GET_PRIVATE((obj), WEBKIT_TYPE_ACCESSIBLE, CyberKitAccessiblePrivate))
...
static const gchar* webkitAccessibleGetName(AtkObject* object)
{
    ...
    returnValIfCyberKitAccessibleIsInvalid(WEBKIT_ACCESSIBLE(object), 0);
...
static gint webkitAccessibleGetIndexInParent(AtkObject* object)
{
    ...
    returnValIfCyberKitAccessibleIsInvalid(WEBKIT_ACCESSIBLE(object), -1);
...
static AtkRole webkitAccessibleGetRole(AtkObject* object)
{
    ...
    returnValIfCyberKitAccessibleIsInvalid(WEBKIT_ACCESSIBLE(object), ATK_ROLE_INVALID);
...
static void webkitAccessibleClassInit(AtkObjectClass* klass)
{
    ...
    g_type_class_add_private(klass, sizeof(CyberKitAccessiblePrivate));
}
...
webkitAccessibleGetType(void)
{
    ...
    if (g_once_init_enter(&typeVolatile)) {
        ...
        GType type = g_type_register_static(ATK_TYPE_OBJECT, "CyberKitAccessible", &tinfo, GTypeFlags(0));
...
{
    CyberKitAccessiblePrivate* priv = WEBKIT_ACCESSIBLE(object)->priv;
