...
macro(MAKE_JS_FILE_ARRAYS _output_cpp _output_h _namespace _scripts _scripts_dependencies)
    add_custom_command(
        ...
        COMMAND ${PYTHON_EXECUTABLE} ${CyberScriptCore_SCRIPTS_DIR}/make-js-file-arrays.py --fail-if-non-ascii -n ${_namespace} ${_output_h} ${_output_cpp} ${${_scripts}}
        VERBATIM)
...
function(GENERATE_DOM_NAMES _namespace _attrs)
    ...
    add_custom_command(
        ...
        COMMAND ${PERL_EXECUTABLE} ${NAMES_GENERATOR} --outputDir ${CyberCore_DERIVED_SOURCES_DIR} ${_arguments} ${_additionArguments}
        VERBATIM)
endfunction()
...
function(GENERATE_DOM_NAME_ENUM _enum)
    add_custom_command(
        OUTPUT ${CyberCore_DERIVED_SOURCES_DIR}/${_enum}.cpp ${CyberCore_DERIVED_SOURCES_DIR}/${_enum}.h
