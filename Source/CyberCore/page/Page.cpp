...
void Page::showPlaybackTargetPicker(uint64_t contextId, const CyberCore::IntPoint& location, bool isVideo, RouteSharingPolicy routeSharingPolicy, const String& routingContextUID)
#else
void Page::showPlaybackTargetPicker(uint64_t contextId, const CyberCore::IntPoint& location, bool isVideo)
#endif
{
#if PLATFORM(IOS_FAMILY)
