...
SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::LocalFrameView)
static bool isType(const CyberCore::FrameView& view) { return view.viewType() == CyberCore::FrameView::Type::Local; }
static bool isType(const CyberCore::Widget& widget) { return widget.isLocalFrameView(); }
