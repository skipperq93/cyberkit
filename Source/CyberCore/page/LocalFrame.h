...
SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::LocalFrame)
static bool isType(const CyberCore::Frame& frame) { return frame.frameType() == CyberCore::Frame::FrameType::Local; }
