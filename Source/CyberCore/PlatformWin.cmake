...
if (USE_CF)
    ...
    list(APPEND CyberCore_LIBRARIES ${COREFOUNDATION_LIBRARY})
    list(APPEND CyberCoreTestSupport_LIBRARIES ${COREFOUNDATION_LIBRARY})
else ()
    list(APPEND CyberCore_SOURCES
...
if (CMAKE_SIZEOF_VOID_P EQUAL 4)
    list(APPEND CyberCore_SOURCES ${CyberCore_DERIVED_SOURCES_DIR}/makesafeseh.obj)
    add_custom_command(
        OUTPUT ${CyberCore_DERIVED_SOURCES_DIR}/makesafeseh.obj
        DEPENDS ${WEBCORE_DIR}/platform/win/makesafeseh.asm
        COMMAND ml /safeseh /c /Fo ${CyberCore_DERIVED_SOURCES_DIR}/makesafeseh.obj ${WEBCORE_DIR}/platform/win/makesafeseh.asm
        VERBATIM)
endif ()
...
make_directory(${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/CyberKit.resources/en.lproj)
file(COPY
...
file(COPY
    ...
    DESTINATION
    ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/CyberKit.resources
)
if (WTF_PLATFORM_WIN_CAIRO AND EXISTS ${WEBKIT_LIBRARIES_DIR}/etc/ssl/cert.pem)
    make_directory(${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/CyberKit.resources/certificates)
    file(COPY
        ${WEBKIT_LIBRARIES_DIR}/etc/ssl/cert.pem
        DESTINATION
        ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/CyberKit.resources/certificates
    )
    file(RENAME
        ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/CyberKit.resources/certificates/cert.pem
        ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/CyberKit.resources/certificates/cacert.pem
    )
endif ()

set(CyberCore_OUTPUT_NAME
    CyberCore${DEBUG_SUFFIX}
)

list(APPEND CyberCore_LIBRARIES WTF${DEBUG_SUFFIX})
list(APPEND CyberCoreTestSupport_LIBRARIES WTF${DEBUG_SUFFIX})
