...
SPECIALIZE_TYPE_TRAITS_ANIMATEDBACKINGSTORECLIENT(CyberCore::CoordinatedAnimatedBackingStoreClient, type() == Nicosia::AnimatedBackingStoreClient::Type::Coordinated)
