...
namespace WTF {
template<> struct EnumTraits<CyberCore::ComponentTransferChannel> {
    using values = EnumValues<CyberCore::ComponentTransferChannel,
        CyberCore::ComponentTransferChannel::Red,
        CyberCore::ComponentTransferChannel::Green,
        CyberCore::ComponentTransferChannel::Blue,
        CyberCore::ComponentTransferChannel::Alpha>;
};
}
