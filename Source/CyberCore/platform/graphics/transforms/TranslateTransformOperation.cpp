...
Ref<TransformOperation> TranslateTransformOperation::blend(const TransformOperation* from, double progress, bool blendToIdentity)
{
    ...
    if (blendToIdentity)
        return TranslateTransformOperation::create(CyberCore::blend(m_x, zeroLength, progress), CyberCore::blend(m_y, zeroLength, progress), CyberCore::blend(m_z, zeroLength, progress), type());
    ...
    return TranslateTransformOperation::create(CyberCore::blend(fromX, x(), progress), CyberCore::blend(fromY, y(), progress), CyberCore::blend(fromZ, z(), progress), type());
}
