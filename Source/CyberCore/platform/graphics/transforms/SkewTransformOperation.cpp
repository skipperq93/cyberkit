...
Ref<TransformOperation> SkewTransformOperation::blend(const TransformOperation* from, double progress, bool blendToIdentity)
{
    ...
    if (blendToIdentity)
        return SkewTransformOperation::create(CyberCore::blend(m_angleX, 0.0, progress), CyberCore::blend(m_angleY, 0.0, progress), type());
    ...
    return SkewTransformOperation::create(CyberCore::blend(fromAngleX, m_angleX, progress), CyberCore::blend(fromAngleY, m_angleY, progress), type());
}
