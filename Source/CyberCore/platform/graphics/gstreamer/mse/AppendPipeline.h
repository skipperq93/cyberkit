...
public:
    ...
    RefPtr<CyberCore::TrackPrivateBase> track() { return m_track; }
...
private:
    ...
    CyberCore::MediaSourceStreamTypeGStreamer streamType() { return m_streamType; }
    ...
    CyberCore::MediaSourceStreamTypeGStreamer m_streamType;
    RefPtr<CyberCore::TrackPrivateBase> m_track;
