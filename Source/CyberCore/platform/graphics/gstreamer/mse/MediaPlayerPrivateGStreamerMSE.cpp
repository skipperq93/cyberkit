...
{
    switch (readyState) {
    case CyberCore::MediaPlayer::HaveNothing: return "HaveNothing";
    case CyberCore::MediaPlayer::HaveMetadata: return "HaveMetadata";
    case CyberCore::MediaPlayer::HaveCurrentData: return "HaveCurrentData";
    case CyberCore::MediaPlayer::HaveFutureData: return "HaveFutureData";
    case CyberCore::MediaPlayer::HaveEnoughData: return "HaveEnoughData";
...
{
    initializeGStreamerAndRegisterCyberKitElements();
...
MediaPlayerPrivateGStreamerMSE::~MediaPlayerPrivateGStreamerMSE()
{
    ...
    if (m_playbackPipeline)
        m_playbackPipeline->setCyberKitMediaSrc(nullptr);
}
...
void MediaPlayerPrivateGStreamerMSE::sourceSetup(GstElement* sourceElement)
{
    ...
    m_playbackPipeline->setCyberKitMediaSrc(WEBKIT_MEDIA_SRC(m_source.get()));
...
void MediaPlayerPrivateGStreamerMSE::trackDetected(RefPtr<AppendPipeline> appendPipeline, RefPtr<CyberCore::TrackPrivateBase> newTrack, bool firstTrackDetected)
{
...
const static HashSet<AtomicString>& codecSet()
{
    static NeverDestroyed<HashSet<AtomicString>> codecTypes = []()
    {
        ...
        GstCapsCyberKitMapping mapping[] = {
