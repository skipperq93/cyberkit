...
// PlaybackPipeline is (sort of) a friend class of CyberKitMediaSourceGStreamer.
...
namespace WTF {
template<> GRefPtr<CyberKitMediaSrc> adoptGRef(CyberKitMediaSrc*);
template<> CyberKitMediaSrc* refGPtr<CyberKitMediaSrc>(CyberKitMediaSrc*);
template<> void derefGPtr<CyberKitMediaSrc>(CyberKitMediaSrc*);
};
...
public:
    ...
    void setCyberKitMediaSrc(CyberKitMediaSrc*);
    CyberKitMediaSrc* webKitMediaSrc();
...
private:
    ...
    GRefPtr<CyberKitMediaSrc> m_webKitMediaSrc;
};
