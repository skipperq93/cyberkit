...
#if ENABLE(VIDEO)
bool getVideoSizeAndFormatFromCaps(const GstCaps*, CyberCore::IntSize&, GstVideoFormat&, int& pixelAspectRatioNumerator, int& pixelAspectRatioDenominator, int& stride);
