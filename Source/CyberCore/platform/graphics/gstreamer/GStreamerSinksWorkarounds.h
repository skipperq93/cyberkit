...
#define WEBKIT_APP_SINK_WITH_WORKAROUNDS(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), WEBKIT_TYPE_APP_SINK_WITH_WORKAROUNDS, CyberKitAppSinkWithWorkaround))
#define WEBKIT_APP_SINK_WITH_WORKAROUNDS_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), WEBKIT_TYPE_APP_SINK_WITH_WORKAROUNDS, CyberKitAppSinkWithWorkaroundClass))
...
#define WEBKIT_APP_SINK_WITH_WORKAROUNDS_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), WEBKIT_TYPE_APP_SINK_WITH_WORKAROUNDS, CyberKitAppSinkWithWorkaroundClass))

struct CyberKitAppSinkWithWorkaroundsPrivate;
struct CyberKitAppSinkWithWorkarounds {
    GstAppSink parent;
    CyberKitAppSinkWithWorkaroundsPrivate* priv;
};

struct CyberKitAppSinkWithWorkaroundsClass {
