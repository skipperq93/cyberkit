...
void webKitWebSrcSetResourceLoader(CyberKitWebSrc*, const RefPtr<CyberCore::PlatformMediaResourceLoader>&);
void webKitWebSrcSetReferrer(CyberKitWebSrc*, const String&);
