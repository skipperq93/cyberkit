...
typedef struct _CyberKitWebSrc        CyberKitWebSrc;
typedef struct _CyberKitWebSrcClass   CyberKitWebSrcClass;
typedef struct _CyberKitWebSrcPrivate CyberKitWebSrcPrivate;

struct _CyberKitWebSrc {
    GstPushSrc parent;

    CyberKitWebSrcPrivate *priv;
};

struct _CyberKitWebSrcClass {
    GstPushSrcClass parentClass;
};

GType webkit_web_src_get_type(void);
void webKitWebSrcSetMediaPlayer(CyberKitWebSrc*, CyberCore::MediaPlayer*);
bool webKitSrcPassedCORSAccessCheck(CyberKitWebSrc*);
bool webKitSrcWouldTaintOrigin(CyberKitWebSrc*, const CyberCore::SecurityOrigin&);
