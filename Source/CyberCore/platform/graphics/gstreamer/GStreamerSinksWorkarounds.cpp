...
static void registerAppsinkWithWorkaroundsIfNeededCallOnce()
{
    ...
    GST_DEBUG_CATEGORY_INIT(webkit_workarounds_debug, "webkitworkarounds", 0, "CyberKit GStreamer Workarounds");
    ...
    GST_DEBUG("CyberKitAppsinkWithWorkarounds WILL%s be registered.", doesNeedWorkarounds ? "" : " NOT");
...
struct CyberKitAppSinkWithWorkaroundsPrivate {
};

#define webkit_app_sink_with_workarounds_parent_class parent_class
WEBKIT_DEFINE_TYPE(CyberKitAppSinkWithWorkarounds, webkit_app_sink_with_workarounds, GST_TYPE_APP_SINK);
...
static void webkitAppSinkWithWorkAroundsConstructed(GObject* object)
{
    ...
    GST_DEBUG_OBJECT(object, "CyberKitAppSinkWithWorkarounds instantiated.");
    CyberCore::AppSinkFlushCapsWorkaroundProbe::installIfNeeded(GST_APP_SINK(object));
    CyberCore::installBaseSinkPositionFlushWorkaroundIfNeeded(GST_BASE_SINK(object));
}

static void webkit_app_sink_with_workarounds_class_init(CyberKitAppSinkWithWorkaroundsClass* klass)
{
