...
G_DEFINE_TYPE_WITH_CODE(CyberKitWebSrc, webkit_web_src, GST_TYPE_PUSH_SRC,
...
static void webkitWebSrcReset(CyberKitWebSrc* src)
{
...
static void webKitWebSrcCloseSession(CyberKitWebSrc* src)
{
    CyberKitWebSrcPrivate* priv = src->priv;
    GRefPtr<CyberKitWebSrc> protector = WTF::ensureGRef(src);
