...
struct CyberKitWebSrcPrivate {
    ...
    struct StreamingMembers {
        ...
        // We use it for getting access to CyberKit networking objects: the PlatformMediaResourceLoader factory [createResourceLoader()]
...
static void webKitWebSrcMakeRequest(CyberKitWebSrc*, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper&);
...
static void restartLoaderIfNeeded(CyberKitWebSrc*, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper&);
static void stopLoaderIfNeeded(CyberKitWebSrc*, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper&);
...
static void webkitWebSrcReset(CyberKitWebSrc* src, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper& members, ResetType resetType)
{
...
static void webKitWebSrcConstructed(GObject* object)
{
    ...
    DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper members(priv->dataMutex);
...
static void restartLoaderIfNeeded(CyberKitWebSrc* src, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper& members)
{
...
static void stopLoaderIfNeeded(CyberKitWebSrc* src, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper& members)
{
    ASSERT(isMainThread());
...
static void webKitWebSrcMakeRequest(CyberKitWebSrc* src, DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper& members)
{
    CyberKitWebSrcPrivate* priv = src->priv;
...
static gboolean webKitWebSrcStop(GstBaseSrc* baseSrc)
{
    ...
    DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper members(src->priv->dataMutex);
    webkitWebSrcReset(src, members, ResetType::Hard);
...
void webKitWebSrcSetMediaPlayer(CyberKitWebSrc* src, CyberCore::MediaPlayer* player)
{
    ASSERT(player);
    DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper members(src->priv->dataMutex);
...
bool webKitSrcWouldTaintOrigin(CyberKitWebSrc* src, const SecurityOrigin& origin)
{
    DataMutex<CyberKitWebSrcPrivate::StreamingMembers>::LockedWrapper members(src->priv->dataMutex);
