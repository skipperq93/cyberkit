...
#define WEBKIT_MEDIA_THUNDER_DECRYPT_GET_PRIVATE(obj) (G_TYPE_INSTANCE_GET_PRIVATE((obj), WEBKIT_TYPE_MEDIA_THUNDER_DECRYPT, CyberKitMediaThunderDecryptPrivate))
struct _CyberKitMediaThunderDecryptPrivate {
...
G_DEFINE_TYPE(CyberKitMediaThunderDecrypt, webkit_media_thunder_decrypt, WEBKIT_TYPE_MEDIA_CENC_DECRYPT);
...
static void webkit_media_thunder_decrypt_class_init(CyberKitMediaThunderDecryptClass* klass)
{
    ...
    g_type_class_add_private(klass, sizeof(CyberKitMediaThunderDecryptPrivate));
}

static void webkit_media_thunder_decrypt_init(CyberKitMediaThunderDecrypt* self)
{
    CyberKitMediaThunderDecryptPrivate* priv = WEBKIT_MEDIA_THUNDER_DECRYPT_GET_PRIVATE(self);
    self->priv = priv;
    new (priv) CyberKitMediaThunderDecryptPrivate();
}

static void finalize(GObject* object)
{
    CyberKitMediaThunderDecrypt* self = WEBKIT_MEDIA_THUNDER_DECRYPT(object);
    CyberKitMediaThunderDecryptPrivate* priv = self->priv;
    priv->~CyberKitMediaThunderDecryptPrivate();

    GST_CALL_PARENT(G_OBJECT_CLASS, finalize, (object));
}

static const char* protectionSystemId(CyberKitMediaCommonEncryptionDecrypt* self)
{
    CyberKitMediaThunderDecryptPrivate* priv = WEBKIT_MEDIA_THUNDER_DECRYPT_GET_PRIVATE(WEBKIT_MEDIA_THUNDER_DECRYPT(self));
...
static bool decrypt(CyberKitMediaCommonEncryptionDecrypt* self, GstBuffer* ivBuffer, GstBuffer* keyIDBuffer, GstBuffer* buffer, unsigned subsampleCount,
