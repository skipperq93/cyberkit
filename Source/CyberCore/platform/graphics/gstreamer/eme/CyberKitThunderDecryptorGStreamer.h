...
#define WEBKIT_MEDIA_THUNDER_DECRYPT(obj)          (G_TYPE_CHECK_INSTANCE_CAST((obj), WEBKIT_TYPE_MEDIA_THUNDER_DECRYPT, CyberKitMediaThunderDecrypt))
#define WEBKIT_MEDIA_THUNDER_DECRYPT_CLASS(klass)  (G_TYPE_CHECK_CLASS_CAST((klass), WEBKIT_TYPE_MEDIA_THUNDER_DECRYPT, CyberKitMediaThunderDecryptClass))
...
typedef struct _CyberKitMediaThunderDecrypt        CyberKitMediaThunderDecrypt;
typedef struct _CyberKitMediaThunderDecryptClass   CyberKitMediaThunderDecryptClass;
typedef struct _CyberKitMediaThunderDecryptPrivate CyberKitMediaThunderDecryptPrivate;

GType webkit_media_thunder_decrypt_get_type(void);

struct _CyberKitMediaThunderDecrypt {
    CyberKitMediaCommonEncryptionDecrypt parent;

    CyberKitMediaThunderDecryptPrivate* priv;
};

struct _CyberKitMediaThunderDecryptClass {
