...
struct _CyberKitMediaCommonEncryptionDecryptClass {
    ...
    gboolean (*handleKeyResponse)(CyberKitMediaCommonEncryptionDecrypt*, GstEvent* event);
    gboolean (*decrypt)(CyberKitMediaCommonEncryptionDecrypt*, GstBuffer* ivBuffer, GstBuffer* keyIDBuffer, GstBuffer* buffer, unsigned subSamplesCount, GstBuffer* subSamplesBuffer);
};
