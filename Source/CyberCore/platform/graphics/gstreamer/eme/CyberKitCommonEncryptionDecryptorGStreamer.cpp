...
static bool webkitMediaCommonEncryptionDecryptIsCDMInstanceAvailable(CyberKitMediaCommonEncryptionDecrypt*);
...
G_DEFINE_TYPE(CyberKitMediaCommonEncryptionDecrypt, webkit_media_common_encryption_decrypt, GST_TYPE_BASE_TRANSFORM);
...
static void webkit_media_common_encryption_decrypt_class_init(CyberKitMediaCommonEncryptionDecryptClass* klass)
{
    ...
    g_type_class_add_private(klass, sizeof(CyberKitMediaCommonEncryptionDecryptPrivate));
}

static void webkit_media_common_encryption_decrypt_init(CyberKitMediaCommonEncryptionDecrypt* self)
{
    CyberKitMediaCommonEncryptionDecryptPrivate* priv = WEBKIT_MEDIA_CENC_DECRYPT_GET_PRIVATE(self);

    self->priv = priv;
    new (priv) CyberKitMediaCommonEncryptionDecryptPrivate();
...
{
    CyberKitMediaCommonEncryptionDecrypt* self = WEBKIT_MEDIA_CENC_DECRYPT(object);
    CyberKitMediaCommonEncryptionDecryptPrivate* priv = self->priv;

    priv->~CyberKitMediaCommonEncryptionDecryptPrivate();
...
static bool webkitMediaCommonEncryptionDecryptIsCDMInstanceAvailable(CyberKitMediaCommonEncryptionDecrypt* self)
{
    CyberKitMediaCommonEncryptionDecryptPrivate* priv = WEBKIT_MEDIA_CENC_DECRYPT_GET_PRIVATE(self);
...
static gboolean webkitMediaCommonEncryptionDecryptorQueryHandler(GstBaseTransform* trans, GstPadDirection direction, GstQuery* query)
{
    if (gst_structure_has_name(gst_query_get_structure(query), "any-decryptor-waiting-for-key")) {
        CyberKitMediaCommonEncryptionDecryptPrivate* priv = WEBKIT_MEDIA_CENC_DECRYPT_GET_PRIVATE(trans);
