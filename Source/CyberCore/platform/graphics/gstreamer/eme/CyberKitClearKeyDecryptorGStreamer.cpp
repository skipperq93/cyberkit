...
static bool handleKeyResponse(CyberKitMediaCommonEncryptionDecrypt* self, RefPtr<ProxyCDM>);
...
static bool handleKeyResponse(CyberKitMediaCommonEncryptionDecrypt* self, RefPtr<ProxyCDM> proxyCDM)
{
...
static bool findAndSetKey(CyberKitMediaClearKeyDecryptPrivate* priv, const String&& keyID)
{
    String keyValue;
