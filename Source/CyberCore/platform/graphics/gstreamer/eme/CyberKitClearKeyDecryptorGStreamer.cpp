...
static bool cdmProxyAttached(CyberKitMediaCommonEncryptionDecrypt* self, const RefPtr<CDMProxy>&);
...
static bool cdmProxyAttached(CyberKitMediaCommonEncryptionDecrypt* self, const RefPtr<CDMProxy>& cdmProxy)
{
