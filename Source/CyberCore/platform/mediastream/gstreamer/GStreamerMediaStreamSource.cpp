...
static void webkitMediaStreamSrcPushVideoSample(CyberKitMediaStreamSrc* self, GstSample* gstsample);
static void webkitMediaStreamSrcPushAudioSample(CyberKitMediaStreamSrc* self, GstSample* gstsample);
static void webkitMediaStreamSrcTrackEnded(CyberKitMediaStreamSrc* self, MediaStreamTrackPrivate&);
static void webkitMediaStreamSrcRemoveTrackByType(CyberKitMediaStreamSrc* self, RealtimeMediaSource::Type trackType);
...
class CyberKitMediaStreamTrackObserver
    : public MediaStreamTrackPrivate::Observer {
    WTF_MAKE_FAST_ALLOCATED;
public:
    virtual ~CyberKitMediaStreamTrackObserver() { };
    CyberKitMediaStreamTrackObserver(CyberKitMediaStreamSrc* src)
...
private:
    CyberKitMediaStreamSrc* m_mediaStreamSrc;
};

class CyberKitMediaStreamObserver
    : public MediaStreamPrivate::Observer {
    WTF_MAKE_FAST_ALLOCATED;
public:
    virtual ~CyberKitMediaStreamObserver() { };
    CyberKitMediaStreamObserver(CyberKitMediaStreamSrc* src)
        : m_mediaStreamSrc(src) { }
...
private:
    GRefPtr<CyberKitMediaStreamSrc> m_mediaStreamSrc;
};
...
struct _CyberKitMediaStreamSrc {
    ...
    struct SourceData {
        ...
        static void needDataCb(GstElement*, guint, CyberKitMediaStreamSrc::SourceData *self)
        {
            self->setEnoughData(false);
        }

        static void enoughDataCb(GstElement*, CyberKitMediaStreamSrc::SourceData *self)
        {
    ...
    std::unique_ptr<CyberKitMediaStreamTrackObserver> mediaStreamTrackObserver;
...
{
    CyberKitMediaStreamSrc* self = WEBKIT_MEDIA_STREAM_SRC(handler);
...
G_DEFINE_TYPE_WITH_CODE(CyberKitMediaStreamSrc, webkit_media_stream_src, GST_TYPE_BIN, doInit);
...
{
    CyberKitMediaStreamSrc* self = WEBKIT_MEDIA_STREAM_SRC(object);
...
static void webkit_media_stream_src_init(CyberKitMediaStreamSrc* self)
{
    self->mediaStreamTrackObserver = makeUnique<CyberKitMediaStreamTrackObserver>(self);
    self->mediaStreamObserver = makeUnique<CyberKitMediaStreamObserver>(self);
...
static GstFlowReturn webkitMediaStreamSrcChain(GstPad* pad, GstObject* parent, GstBuffer* buffer)
{
    ...
    GRefPtr<CyberKitMediaStreamSrc> self = adoptGRef(WEBKIT_MEDIA_STREAM_SRC(gst_object_get_parent(parent)));
...
static void webkitMediaStreamSrcAddPad(CyberKitMediaStreamSrc* self, GstPad* target, GstStaticPadTemplate* pad_template)
{
...
static GstPadProbeReturn webkitMediaStreamSrcPadProbeCb(GstPad* pad, GstPadProbeInfo* info, ProbeData* data)
{
    ...
    CyberKitMediaStreamSrc* self = data->self;
...
static gboolean webkitMediaStreamSrcSetupSrc(CyberKitMediaStreamSrc* self,
...
static gboolean webkitMediaStreamSrcSetupAppSrc(CyberKitMediaStreamSrc* self,
    MediaStreamTrackPrivate* track, CyberKitMediaStreamSrc::SourceData* data,
...
static void webkitMediaStreamSrcPostStreamCollection(CyberKitMediaStreamSrc* self, MediaStreamPrivate* stream)
{
    GST_OBJECT_LOCK(self);
...
bool webkitMediaStreamSrcAddTrack(CyberKitMediaStreamSrc* self, MediaStreamTrackPrivate* track, bool onlyTrack)
{
    bool res = false;
    if (track->type() == RealtimeMediaSource::Type::Audio)
...
bool webkitMediaStreamSrcSetStream(CyberKitMediaStreamSrc* self, MediaStreamPrivate* stream)
{
...
static void webkitMediaStreamSrcTrackEnded(CyberKitMediaStreamSrc* self,
