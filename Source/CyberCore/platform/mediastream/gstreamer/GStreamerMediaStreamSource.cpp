...
static void webkitMediaStreamSrcEnsureStreamCollectionPosted(CyberKitMediaStreamSrc*, bool);
...
void CyberKitMediaStreamObserver::activeStatusChanged()
{
...
void CyberKitMediaStreamObserver::didRemoveTrack(MediaStreamTrackPrivate& track)
{
    ...
    // Properly stop data flow. The source stops observing notifications from CyberCore.
...
static void webkitMediaStreamSrcEnsureStreamCollectionPosted(CyberKitMediaStreamSrc* self, bool force)
{
...
void webkitMediaStreamSrcAddTrack(CyberKitMediaStreamSrc* self, MediaStreamTrackPrivate* track, bool onlyTrack, bool consumerIsVideoPlayer)
{
