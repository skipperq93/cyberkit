...
static void webkitMediaStreamSrcPushVideoSample(CyberKitMediaStreamSrc*, GstSample*);
static void webkitMediaStreamSrcPushAudioSample(CyberKitMediaStreamSrc*, GstSample*);
static void webkitMediaStreamSrcTrackEnded(CyberKitMediaStreamSrc*, MediaStreamTrackPrivate&);
static void webkitMediaStreamSrcRemoveTrackByType(CyberKitMediaStreamSrc*, RealtimeMediaSource::Type);
...
public:
    ...
    CyberKitMediaStreamTrackObserver(GstElement* src)
        : m_src(src) { }
...
static void webkitMediaStreamSrcConstructed(GObject* object)
{
    ...
    priv->mediaStreamTrackObserver = makeUnique<CyberKitMediaStreamTrackObserver>(GST_ELEMENT_CAST(self));
...
static void stopObservingTracks(CyberKitMediaStreamSrc* self)
{
...
static void webkitMediaStreamSrcAddPad(CyberKitMediaStreamSrc* self, GstPad* target, GstStaticPadTemplate* padTemplate, GRefPtr<GstTagList>&& tags)
{
...
static GstPadProbeReturn webkitMediaStreamSrcPadProbeCb(GstPad* pad, GstPadProbeInfo* info, ProbeData* data)
{
    ...
    CyberKitMediaStreamSrc* self = WEBKIT_MEDIA_STREAM_SRC(data->element.get());
...
static void webkitMediaStreamSrcSetupSrc(CyberKitMediaStreamSrc* self, MediaStreamTrackPrivate* track, GstElement* element, GstStaticPadTemplate* padTemplate, bool onlyTrack)
{
...
void webkitMediaStreamSrcSetStream(CyberKitMediaStreamSrc* self, MediaStreamPrivate* stream)
{
...
static void webkitMediaStreamSrcPushVideoSample(CyberKitMediaStreamSrc* self, GstSample* sample)
{
    if (self->priv->videoSrc)
        self->priv->videoSrc->pushSample(sample);
}

static void webkitMediaStreamSrcPushAudioSample(CyberKitMediaStreamSrc* self, GstSample* sample)
{
    if (self->priv->audioSrc)
        self->priv->audioSrc->pushSample(sample);
}

static void webkitMediaStreamSrcTrackEnded(CyberKitMediaStreamSrc* self, MediaStreamTrackPrivate& track)
{
    GRefPtr<GstPad> pad;
