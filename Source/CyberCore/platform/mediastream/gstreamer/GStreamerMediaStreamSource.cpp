...
{
    self->mediaStreamTrackObserver = std::make_unique<CyberKitMediaStreamTrackObserver>(self);
    self->mediaStreamObserver = std::make_unique<CyberKitMediaStreamObserver>(self);
