...
static void webkit_mock_device_provider_class_init(GStreamerMockDeviceProviderClass* klass)
{
    ...
    gst_device_provider_class_set_static_metadata(providerClass, "CyberKit Mock Device Provider", "Source/Audio/Video",
        "List and provide CyberKit mock source devices", "Philippe Normand <philn@igalia.com>");
}
