...
bool webkitMediaStreamSrcSetStream(CyberKitMediaStreamSrc*, MediaStreamPrivate*);
bool webkitMediaStreamSrcAddTrack(CyberKitMediaStreamSrc*, MediaStreamTrackPrivate*, bool onlyTrack);
