...
WEBKIT_DEFINE_TYPE_WITH_CODE(CyberKitVideoEncoder, webkit_video_encoder, GST_TYPE_BIN,
    GST_DEBUG_CATEGORY_INIT(video_encoder_debug, "webkitvideoencoderprivate", 0, "CyberKit Video Encoder Private"))
...
static bool videoEncoderSetEncoder(CyberKitVideoEncoder* self, EncoderId encoderId, GRefPtr<GstCaps>&& encodedCaps)
{
