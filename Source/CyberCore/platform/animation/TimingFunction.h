...
template<> struct EnumTraits<CyberCore::CubicBezierTimingFunction::TimingFunctionPreset> {
    using values = EnumValues<
        CyberCore::CubicBezierTimingFunction::TimingFunctionPreset,
        CyberCore::CubicBezierTimingFunction::TimingFunctionPreset::Ease,
        CyberCore::CubicBezierTimingFunction::TimingFunctionPreset::EaseIn,
        CyberCore::CubicBezierTimingFunction::TimingFunctionPreset::EaseOut,
        CyberCore::CubicBezierTimingFunction::TimingFunctionPreset::EaseInOut,
        CyberCore::CubicBezierTimingFunction::TimingFunctionPreset::Custom
    >;
};

template<> struct EnumTraits<CyberCore::StepsTimingFunction::StepPosition> {
    using values = EnumValues<
        CyberCore::StepsTimingFunction::StepPosition,
        CyberCore::StepsTimingFunction::StepPosition::JumpStart,
        CyberCore::StepsTimingFunction::StepPosition::JumpEnd,
        CyberCore::StepsTimingFunction::StepPosition::JumpNone,
        CyberCore::StepsTimingFunction::StepPosition::JumpBoth,
        CyberCore::StepsTimingFunction::StepPosition::Start,
        CyberCore::StepsTimingFunction::StepPosition::End
    >;
};

template<> struct EnumTraits<CyberCore::TimingFunction::TimingFunctionType> {
    using values = EnumValues<
        CyberCore::TimingFunction::TimingFunctionType,
        CyberCore::TimingFunction::TimingFunctionType::LinearFunction,
        CyberCore::TimingFunction::TimingFunctionType::CubicBezierFunction,
        CyberCore::TimingFunction::TimingFunctionType::StepsFunction,
        CyberCore::TimingFunction::TimingFunctionType::SpringFunction
    >;
};
