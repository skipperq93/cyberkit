...
{
    return CyberCore::subspaceForImpl<JSTestNamedSetterWithIndexedGetter, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedSetterWithIndexedGetter@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore32TestNamedSetterWithIndexedGetterE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedSetterWithIndexedGetter@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore32TestNamedSetterWithIndexedGetterE[2];
#endif
