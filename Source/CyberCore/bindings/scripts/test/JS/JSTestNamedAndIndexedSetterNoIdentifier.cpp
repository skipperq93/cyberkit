...
{
    return CyberCore::subspaceForImpl<JSTestNamedAndIndexedSetterNoIdentifier, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedAndIndexedSetterNoIdentifier@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore37TestNamedAndIndexedSetterNoIdentifierE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedAndIndexedSetterNoIdentifier@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore37TestNamedAndIndexedSetterNoIdentifierE[2];
#endif
