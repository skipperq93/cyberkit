...
{
    return CyberCore::subspaceForImpl<JSTestClassWithJSBuiltinConstructor, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestClassWithJSBuiltinConstructor@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore33TestClassWithJSBuiltinConstructorE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestClassWithJSBuiltinConstructor@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore33TestClassWithJSBuiltinConstructorE[2];
#endif
