...
{
    return CyberCore::subspaceForImpl<JSTestNamedDeleterNoIdentifier, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedDeleterNoIdentifier@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore28TestNamedDeleterNoIdentifierE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedDeleterNoIdentifier@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore28TestNamedDeleterNoIdentifierE[2];
#endif
