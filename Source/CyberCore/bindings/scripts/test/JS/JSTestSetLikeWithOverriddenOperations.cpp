...
{
    return CyberCore::subspaceForImpl<JSTestSetLikeWithOverriddenOperations, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestSetLikeWithOverriddenOperations@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore35TestSetLikeWithOverriddenOperationsE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestSetLikeWithOverriddenOperations@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore35TestSetLikeWithOverriddenOperationsE[2];
#endif
