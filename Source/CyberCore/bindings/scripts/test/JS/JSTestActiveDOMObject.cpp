...
extern "C" { extern void (*const __identifier("??_7TestActiveDOMObject@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore19TestActiveDOMObjectE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
    void* expectedVTablePointer = WTF_PREPARE_VTBL_POINTER_FOR_INSPECTION(__identifier("??_7TestActiveDOMObject@CyberCore@@6B@"));
#else
    void* expectedVTablePointer = WTF_PREPARE_VTBL_POINTER_FOR_INSPECTION(&_ZTVN7CyberCore19TestActiveDOMObjectE[2]);
#endif
