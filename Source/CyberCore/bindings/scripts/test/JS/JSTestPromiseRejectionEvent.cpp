...
{
    return CyberCore::subspaceForImpl<JSTestPromiseRejectionEvent, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestPromiseRejectionEvent@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore25TestPromiseRejectionEventE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestPromiseRejectionEvent@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore25TestPromiseRejectionEventE[2];
#endif
