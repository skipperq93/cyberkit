...
extern "C" { extern void (*const __identifier("??_7ReadOnlySetLike@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore15ReadOnlySetLikeE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
    void* expectedVTablePointer = WTF_PREPARE_VTBL_POINTER_FOR_INSPECTION(__identifier("??_7ReadOnlySetLike@CyberCore@@6B@"));
#else
    void* expectedVTablePointer = WTF_PREPARE_VTBL_POINTER_FOR_INSPECTION(&_ZTVN7CyberCore15ReadOnlySetLikeE[2]);
#endif
