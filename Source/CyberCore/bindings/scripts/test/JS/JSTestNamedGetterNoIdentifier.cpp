...
{
    return CyberCore::subspaceForImpl<JSTestNamedGetterNoIdentifier, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedGetterNoIdentifier@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore27TestNamedGetterNoIdentifierE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedGetterNoIdentifier@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore27TestNamedGetterNoIdentifierE[2];
#endif
