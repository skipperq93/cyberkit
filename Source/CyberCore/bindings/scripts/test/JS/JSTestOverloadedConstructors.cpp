...
{
    return CyberCore::subspaceForImpl<JSTestOverloadedConstructors, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestOverloadedConstructors@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore26TestOverloadedConstructorsE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestOverloadedConstructors@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore26TestOverloadedConstructorsE[2];
#endif
