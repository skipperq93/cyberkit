...
{
    return CyberCore::subspaceForImpl<JSTestReadOnlyMapLike, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestReadOnlyMapLike@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore19TestReadOnlyMapLikeE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestReadOnlyMapLike@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore19TestReadOnlyMapLikeE[2];
#endif
