...
{
    return CyberCore::subspaceForImpl<JSTestNamedSetterNoIdentifier, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedSetterNoIdentifier@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore27TestNamedSetterNoIdentifierE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedSetterNoIdentifier@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore27TestNamedSetterNoIdentifierE[2];
#endif
