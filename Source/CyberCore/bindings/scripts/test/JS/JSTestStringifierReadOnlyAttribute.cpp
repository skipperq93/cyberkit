...
{
    return CyberCore::subspaceForImpl<JSTestStringifierReadOnlyAttribute, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestStringifierReadOnlyAttribute@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore32TestStringifierReadOnlyAttributeE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestStringifierReadOnlyAttribute@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore32TestStringifierReadOnlyAttributeE[2];
#endif
