...
{
    return CyberCore::subspaceForImpl<JSTestOperationConditional, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestOperationConditional@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore24TestOperationConditionalE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestOperationConditional@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore24TestOperationConditionalE[2];
#endif
