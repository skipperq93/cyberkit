...
{
    return CyberCore::subspaceForImpl<JSTestNamedDeleterWithIndexedGetter, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedDeleterWithIndexedGetter@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore33TestNamedDeleterWithIndexedGetterE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedDeleterWithIndexedGetter@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore33TestNamedDeleterWithIndexedGetterE[2];
#endif
