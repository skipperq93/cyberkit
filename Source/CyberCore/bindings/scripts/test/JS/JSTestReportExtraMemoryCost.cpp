...
{
    return CyberCore::subspaceForImpl<JSTestReportExtraMemoryCost, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestReportExtraMemoryCost@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore25TestReportExtraMemoryCostE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestReportExtraMemoryCost@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore25TestReportExtraMemoryCostE[2];
#endif
