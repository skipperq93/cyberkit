...
{
    return CyberCore::subspaceForImpl<JSTestGenerateIsReachable, UseCustomHeapCellType::No>(vm,
...
bool JSTestGenerateIsReachableOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, const char** reason)
{
    ...
    return containsCyberCoreOpaqueRoot(visitor, owner);
}
...
extern "C" { extern void (*const __identifier("??_7TestGenerateIsReachable@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore23TestGenerateIsReachableE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestGenerateIsReachable@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore23TestGenerateIsReachableE[2];
#endif
