...
{
    return CyberCore::subspaceForImpl<JSTestEnabledForContext, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestEnabledForContext@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore21TestEnabledForContextE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestEnabledForContext@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore21TestEnabledForContextE[2];
#endif
