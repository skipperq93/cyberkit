...
{
    return CyberCore::subspaceForImpl<JSTestDelegateToSharedSyntheticAttribute, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestDelegateToSharedSyntheticAttribute@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore38TestDelegateToSharedSyntheticAttributeE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestDelegateToSharedSyntheticAttribute@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore38TestDelegateToSharedSyntheticAttributeE[2];
#endif
