...
{
    return CyberCore::subspaceForImpl<JSTestMapLikeWithOverriddenOperations, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestMapLikeWithOverriddenOperations@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore35TestMapLikeWithOverriddenOperationsE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestMapLikeWithOverriddenOperations@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore35TestMapLikeWithOverriddenOperationsE[2];
#endif
