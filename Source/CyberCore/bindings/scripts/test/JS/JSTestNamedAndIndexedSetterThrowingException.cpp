...
{
    return CyberCore::subspaceForImpl<JSTestNamedAndIndexedSetterThrowingException, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedAndIndexedSetterThrowingException@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore42TestNamedAndIndexedSetterThrowingExceptionE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedAndIndexedSetterThrowingException@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore42TestNamedAndIndexedSetterThrowingExceptionE[2];
#endif
