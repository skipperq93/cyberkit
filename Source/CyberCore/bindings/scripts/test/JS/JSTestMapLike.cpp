...
{
    return CyberCore::subspaceForImpl<JSTestMapLike, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestMapLike@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore11TestMapLikeE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestMapLike@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore11TestMapLikeE[2];
#endif
