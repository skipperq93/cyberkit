...
extern "C" { extern void (*const __identifier("??_7TestNamedSetterWithUnforgablePropertiesAndOverrideBuiltins@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore58TestNamedSetterWithUnforgablePropertiesAndOverrideBuiltinsE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
    void* expectedVTablePointer = WTF_PREPARE_VTBL_POINTER_FOR_INSPECTION(__identifier("??_7TestNamedSetterWithUnforgablePropertiesAndOverrideBuiltins@CyberCore@@6B@"));
#else
    void* expectedVTablePointer = WTF_PREPARE_VTBL_POINTER_FOR_INSPECTION(&_ZTVN7CyberCore58TestNamedSetterWithUnforgablePropertiesAndOverrideBuiltinsE[2]);
#endif
