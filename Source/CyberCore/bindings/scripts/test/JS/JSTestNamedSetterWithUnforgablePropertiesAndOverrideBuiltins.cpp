...
#if PLATFORM(WIN)
    void* expectedVTablePointer = __identifier("??_7TestNamedSetterWithUnforgablePropertiesAndOverrideBuiltins@CyberCore@@6B@");
#else
    void* expectedVTablePointer = &_ZTVN7CyberCore58TestNamedSetterWithUnforgablePropertiesAndOverrideBuiltinsE[2];
#endif
