...
{
    return CyberCore::subspaceForImpl<JSTestLegacyFactoryFunction, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestLegacyFactoryFunction@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore25TestLegacyFactoryFunctionE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestLegacyFactoryFunction@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore25TestLegacyFactoryFunctionE[2];
#endif
