...
{
    return CyberCore::subspaceForImpl<JSTestDefaultToJSONFilteredByExposed, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestDefaultToJSONFilteredByExposed@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore34TestDefaultToJSONFilteredByExposedE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestDefaultToJSONFilteredByExposed@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore34TestDefaultToJSONFilteredByExposedE[2];
#endif
