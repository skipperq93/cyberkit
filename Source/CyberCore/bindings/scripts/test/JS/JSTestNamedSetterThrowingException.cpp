...
{
    return CyberCore::subspaceForImpl<JSTestNamedSetterThrowingException, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedSetterThrowingException@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore32TestNamedSetterThrowingExceptionE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedSetterThrowingException@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore32TestNamedSetterThrowingExceptionE[2];
#endif
