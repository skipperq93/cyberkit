...
{
    return CyberCore::subspaceForImpl<JSTestIndexedSetterNoIdentifier, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestIndexedSetterNoIdentifier@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore29TestIndexedSetterNoIdentifierE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestIndexedSetterNoIdentifier@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore29TestIndexedSetterNoIdentifierE[2];
#endif
