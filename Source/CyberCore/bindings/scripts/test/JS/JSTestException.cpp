...
{
    return CyberCore::subspaceForImpl<JSTestException, UseCustomHeapCellType::No>(vm,
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestException@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore13TestExceptionE[2];
#endif
