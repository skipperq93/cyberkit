...
{
    return CyberCore::subspaceForImpl<JSTestStringifierOperationNamedToString, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestStringifierOperationNamedToString@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore37TestStringifierOperationNamedToStringE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestStringifierOperationNamedToString@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore37TestStringifierOperationNamedToStringE[2];
#endif
