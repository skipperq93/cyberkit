...
{
    return CyberCore::subspaceForImpl<JSTestStringifierNamedOperation, UseCustomHeapCellType::No>(vm,
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestStringifierNamedOperation@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore29TestStringifierNamedOperationE[2];
#endif
