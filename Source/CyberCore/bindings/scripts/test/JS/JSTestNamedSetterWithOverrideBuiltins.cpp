...
#if PLATFORM(WIN)
    void* expectedVTablePointer = __identifier("??_7TestNamedSetterWithOverrideBuiltins@CyberCore@@6B@");
#else
    void* expectedVTablePointer = &_ZTVN7CyberCore35TestNamedSetterWithOverrideBuiltinsE[2];
#endif
