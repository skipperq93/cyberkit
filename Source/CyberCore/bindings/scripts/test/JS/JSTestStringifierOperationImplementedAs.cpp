...
{
    return CyberCore::subspaceForImpl<JSTestStringifierOperationImplementedAs, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestStringifierOperationImplementedAs@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore37TestStringifierOperationImplementedAsE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestStringifierOperationImplementedAs@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore37TestStringifierOperationImplementedAsE[2];
#endif
