...
{
    return CyberCore::subspaceForImpl<JSTestNamedGetterCallWith, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedGetterCallWith@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore23TestNamedGetterCallWithE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedGetterCallWith@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore23TestNamedGetterCallWithE[2];
#endif
