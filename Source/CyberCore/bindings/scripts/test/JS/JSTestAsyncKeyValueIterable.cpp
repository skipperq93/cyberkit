...
public:
    ...
    template<typename, SubspaceAccess mode> static JSC::GCClient::IsoSubspace* subspaceFor(JSC::VM& vm)
    {
        if constexpr (mode == JSC::SubspaceAccess::Concurrently)
            return nullptr;
        return CyberCore::subspaceForImpl<TestAsyncKeyValueIterableIterator, UseCustomHeapCellType::No>(vm,
...
{
    return CyberCore::subspaceForImpl<JSTestAsyncKeyValueIterable, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestAsyncKeyValueIterable@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore25TestAsyncKeyValueIterableE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestAsyncKeyValueIterable@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore25TestAsyncKeyValueIterableE[2];
#endif
