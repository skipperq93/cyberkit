...
{
    return CyberCore::subspaceForImpl<JSTestNamedSetterWithLegacyUnforgeableProperties, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestNamedSetterWithLegacyUnforgeableProperties@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore46TestNamedSetterWithLegacyUnforgeablePropertiesE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestNamedSetterWithLegacyUnforgeableProperties@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore46TestNamedSetterWithLegacyUnforgeablePropertiesE[2];
#endif
