...
{
    return CyberCore::subspaceForImpl<JSTestTaggedWrapper, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestTaggedWrapper@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore17TestTaggedWrapperE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestTaggedWrapper@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore17TestTaggedWrapperE[2];
#endif
