...
#if PLATFORM(WIN)
    void* expectedVTablePointer = __identifier("??_7TestNamedSetterWithUnforgableProperties@CyberCore@@6B@");
#else
    void* expectedVTablePointer = &_ZTVN7CyberCore39TestNamedSetterWithUnforgablePropertiesE[2];
#endif
