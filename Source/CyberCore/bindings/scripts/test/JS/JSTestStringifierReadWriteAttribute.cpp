...
{
    return CyberCore::subspaceForImpl<JSTestStringifierReadWriteAttribute, UseCustomHeapCellType::No>(vm,
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestStringifierReadWriteAttribute@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore33TestStringifierReadWriteAttributeE[2];
#endif
