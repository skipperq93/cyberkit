...
{
    return CyberCore::subspaceForImpl<JSTestStringifierAnonymousOperation, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestStringifierAnonymousOperation@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore33TestStringifierAnonymousOperationE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestStringifierAnonymousOperation@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore33TestStringifierAnonymousOperationE[2];
#endif
