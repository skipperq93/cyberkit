...
{
    return CyberCore::subspaceForImpl<JSTestPluginInterface, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestPluginInterface@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore19TestPluginInterfaceE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestPluginInterface@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore19TestPluginInterfaceE[2];
#endif
