...
{
    { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsTestInterfaceLeadingUnderscoreConstructor, 0 } },
    { "readonly"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsTestInterfaceLeadingUnderscore_readonly, 0 } },
};
...
{
    return CyberCore::subspaceForImpl<JSTestInterfaceLeadingUnderscore, UseCustomHeapCellType::No>(vm,
...
extern "C" { extern void (*const __identifier("??_7TestInterfaceLeadingUnderscore@CyberCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7CyberCore30TestInterfaceLeadingUnderscoreE[]; }
#endif
#endif
...
#if PLATFORM(WIN)
        void* expectedVTablePointer = __identifier("??_7TestInterfaceLeadingUnderscore@CyberCore@@6B@");
#else
        void* expectedVTablePointer = &_ZTVN7CyberCore30TestInterfaceLeadingUnderscoreE[2];
#endif
