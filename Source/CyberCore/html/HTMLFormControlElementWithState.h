...
SPECIALIZE_TYPE_TRAITS_BEGIN(CyberCore::HTMLFormControlElementWithState)
    static bool isType(const CyberCore::FormAssociatedElement& element) { return element.isFormControlElementWithState(); }
