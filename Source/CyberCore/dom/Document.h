...
#if ENABLE(WIRELESS_PLAYBACK_TARGET)
    typedef HashMap<uint64_t, CyberCore::MediaPlaybackTargetClient*> TargetIdToClientMap;
    TargetIdToClientMap m_idToClientMap;
    typedef HashMap<CyberCore::MediaPlaybackTargetClient*, uint64_t> TargetClientToIdMap;
