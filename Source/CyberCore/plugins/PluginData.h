...
template<> struct EnumTraits<CyberCore::PluginLoadClientPolicy> {
    using values = EnumValues<
        CyberCore::PluginLoadClientPolicy,
        CyberCore::PluginLoadClientPolicy::Undefined,
        CyberCore::PluginLoadClientPolicy::Block,
        CyberCore::PluginLoadClientPolicy::Ask,
        CyberCore::PluginLoadClientPolicy::Allow,
        CyberCore::PluginLoadClientPolicy::AllowAlways
    >;
};
