...
# CyberKit builds ANGLE as a static library, and exports some of the
# internal header files as "public headers" in the Xcode project for
# consumption by other build targets - e.g. CyberCore.
#
...
# the other build targets (like CyberCore) that we could make the
...
# sources, and allows CyberCore to more easily call ANGLE APIs directly.
