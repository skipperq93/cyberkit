...
if (ENABLE_2022_GLIB_API)
    set(CyberKitGTKWebProcessExtension_PKGCONFIG_FILE ${CMAKE_BINARY_DIR}/Source/CyberKit/webkitgtk-web-process-extension-${WEBKITGTK_API_VERSION}.pc)
else ()
    set(CyberKitGTKWebProcessExtension_PKGCONFIG_FILE ${CMAKE_BINARY_DIR}/Source/CyberKit/webkit2gtk-web-extension-${WEBKITGTK_API_VERSION}.pc)
endif ()
