if (NOT TARGET CyberKit::WTF)
    if (NOT INTERNAL_BUILD)
        message(FATAL_ERROR "CyberKit::WTF target not found")
    endif ()
    ...
    add_library(CyberKit::WTF SHARED IMPORTED)
    set_target_properties(CyberKit::WTF PROPERTIES
    ...
    target_include_directories(CyberKit::WTF INTERFACE
