...
if (ENABLE_INTROSPECTION)
    install(FILES ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.gir
            DESTINATION ${INTROSPECTION_INSTALL_GIRDIR}
    )
    install(FILES ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.typelib
...
if (ENABLE_INTROSPECTION)
    ...
    add_custom_command(
        OUTPUT ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.gir
        DEPENDS CyberScriptCore
    ...
    add_custom_command(
        OUTPUT ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.typelib
        DEPENDS ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.gir
        COMMAND ${INTROSPECTION_COMPILER} --includedir=${CMAKE_BINARY_DIR} ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.gir -o ${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.typelib
        VERBATIM
    )

    ADD_TYPELIB(${CMAKE_BINARY_DIR}/CyberScriptCore-${WEBKITGTK_API_VERSION}.typelib)
endif ()

file(WRITE ${CMAKE_BINARY_DIR}/gtkdoc-jsc-glib.cfg
    "[jsc-glib-${WEBKITGTK_API_VERSION}]\n"
    "pkgconfig_file=${CyberScriptCore_PKGCONFIG_FILE}\n"
    "decorator=JSC_API\n"
    ...
    "headers=${CyberScriptCore_INSTALLED_HEADERS}\n"
