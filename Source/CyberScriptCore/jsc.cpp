...
#if __has_include(<CyberKitAdditions/MemoryFootprint.h>)
#include <CyberKitAdditions/MemoryFootprint.h>
#else
...
struct DirectoryName {
    ...
    // If the directory name is "/home/CyberKit", this becomes "home/CyberKit". If the directory name is "/", this becomes "".
    String queryName;
};
