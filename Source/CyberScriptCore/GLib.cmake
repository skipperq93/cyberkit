file(MAKE_DIRECTORY ${FORWARDING_HEADERS_DIR}/CyberScriptCore/glib)
...
add_custom_command(
    OUTPUT ${FORWARDING_HEADERS_DIR}/CyberScriptCore/glib/jsc
    DEPENDS ${JAVASCRIPTCORE_DIR}/API/glib
    COMMAND ln -n -s -f ${JAVASCRIPTCORE_DIR}/API/glib ${FORWARDING_HEADERS_DIR}/CyberScriptCore/glib/jsc
    VERBATIM
)
add_custom_target(JSC-fake-api-headers
    DEPENDS ${FORWARDING_HEADERS_DIR}/CyberScriptCore/glib/jsc
)
