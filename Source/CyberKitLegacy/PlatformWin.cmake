...
list(APPEND CyberKitLegacy_LIBRARIES PRIVATE WTF${DEBUG_SUFFIX})

add_custom_command(
    OUTPUT ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitVersion.h
    ...
    VERBATIM)
list(APPEND CyberKitLegacy_SOURCES ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitVersion.h)
...
list(APPEND CyberKitLegacy_INCLUDE_DIRECTORIES
    ...
    "${DERIVED_SOURCES_DIR}/CyberKitLegacy"
)
...
if (COMPILER_IS_GCC_OR_CLANG)
    WEBKIT_ADD_TARGET_CXX_FLAGS(CyberKitLegacy -Wno-overloaded-virtual)
endif ()
...
add_library(CyberKitLegacyGUID STATIC
    "${DERIVED_SOURCES_WEBKITLEGACY_DIR}/Interfaces/CyberKit.h"
    ...
    "${DERIVED_SOURCES_WEBKITLEGACY_DIR}/Interfaces/CyberKit_i.c"
...
WEBKIT_MAKE_FORWARDING_HEADERS(CyberKitLegacyGUID
    DESTINATION ${FORWARDING_HEADERS_DIR}/CyberKitLegacy
    FILES win/CyberKitCOMAPI.h win/CFDictionaryPropertyBag.h
