...
function(GENERATE_INTERFACE _infile)
    ...
    set(output ${CyberKitLegacy_DERIVED_SOURCES_DIR}/Interfaces/${_filewe}.h)
    if (NOT ${opt_HEADER_ONLY})
        list(APPEND output ${CyberKitLegacy_DERIVED_SOURCES_DIR}/Interfaces/${_filewe}_i.c)
    endif ()
    add_custom_command(
        OUTPUT ${output}
        MAIN_DEPENDENCY ${_infile}
        DEPENDS ${WEBKITLEGACY_IDL_DEPENDENCIES}
        COMMAND midl.exe /I "${CMAKE_CURRENT_SOURCE_DIR}/win/Interfaces" /I "${CMAKE_CURRENT_SOURCE_DIR}/win/Interfaces/Accessible2" /I "${CyberKitLegacy_DERIVED_SOURCES_DIR}/include" /I "${CMAKE_CURRENT_SOURCE_DIR}/win" /WX /char signed /env win32 /tlb "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${_filewe}.tlb" /out "${CyberKitLegacy_DERIVED_SOURCES_DIR}/Interfaces" /h "${CyberKitLegacy_DERIVED_SOURCES_DIR}/Interfaces/${_filewe}.h" /iid "${_filewe}_i.c" ${MIDL_DEFINES} "${CMAKE_CURRENT_SOURCE_DIR}/${_infile}"
...
GENERATE_INTERFACE(win/Interfaces/CyberKit.idl)
...
list(APPEND CyberKitLegacy_PRIVATE_LIBRARIES ${CXX_LIBS})
...
if (NOT INTERNAL_BUILD)
    add_dependencies(CyberKitLegacyFrameworkHeaders CyberCore_CopyPrivateHeaders)
endif ()
...
list(APPEND CyberKitLegacy_PRIVATE_DEFINITIONS
