...
public:
    ...
    void startPingLoad(CyberCore::LocalFrame&, CyberCore::ResourceRequest&, const CyberCore::HTTPHeaderMap&, const CyberCore::FetchOptions&, CyberCore::ContentSecurityPolicyImposition, PingLoadCompletionHandler&&) final;
