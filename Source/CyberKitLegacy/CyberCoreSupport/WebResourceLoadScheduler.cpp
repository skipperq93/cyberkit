...
void WebResourceLoadScheduler::loadResource(LocalFrame& frame, CachedResource& resource, ResourceRequest&& request, const ResourceLoaderOptions& options, CompletionHandler<void(RefPtr<CyberCore::SubresourceLoader>&&)>&& completionHandler)
{
...
void WebResourceLoadScheduler::schedulePluginStreamLoad(LocalFrame& frame, NetscapePlugInStreamLoaderClient& client, ResourceRequest&& request, CompletionHandler<void(RefPtr<CyberCore::NetscapePlugInStreamLoader>&&)>&& completionHandler)
{
