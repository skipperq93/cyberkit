...
list(APPEND CyberKitLegacy_INCLUDE_DIRECTORIES
...
set(CyberKitLegacy_FORWARDING_HEADERS_FILES
    ...
    mac/CyberCoreSupport/WebKeyGenerator.h
...
add_custom_command(
    OUTPUT
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginAgentReplyServer.c
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginAgentReplyUser.c
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginAgentServer.c
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginAgentUser.c
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginHostServer.c
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginHostUser.c
...
add_custom_command(
    OUTPUT
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginClientServer.c
        ${DERIVED_SOURCES_WEBKITLEGACY_DIR}/CyberKitPluginClientUser.c
...
WEBKIT_CREATE_FORWARDING_HEADERS(CyberKitLegacy DIRECTORIES ${CyberKitLegacy_FORWARDING_HEADERS_DIRECTORIES} FILES ${CyberKitLegacy_FORWARDING_HEADERS_FILES})
...
foreach (_file ${ObjCHeaders})
    ...
    if (NOT EXISTS ${FORWARDING_HEADERS_DIR}/CyberKitLegacy/${_name})
        file(WRITE ${FORWARDING_HEADERS_DIR}/CyberKitLegacy/${_name} "#import <CyberCore/${_name}>")
    endif ()
endforeach ()
