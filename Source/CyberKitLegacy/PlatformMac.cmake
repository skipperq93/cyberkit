...
list(APPEND CyberKitLegacy_PRIVATE_INCLUDE_DIRECTORIES
    ...
    "${DERIVED_SOURCES_DIR}/ForwardingHeaders/CyberCore"
    "${DERIVED_SOURCES_DIR}/ForwardingHeaders/CyberKitLegacy"
)
...
foreach (_file ${CyberKitLegacy_LEGACY_FORWARDING_HEADERS_FILES})
    ...
    set(_target_filename "${DERIVED_SOURCES_DIR}/ForwardingHeaders/CyberKitLegacy/${_name}")
    if (NOT EXISTS ${_target_filename})
        file(WRITE ${_target_filename} "#import \"${_file}\"")
    endif ()
endforeach ()

if (NOT EXISTS ${CyberKitLegacy_DERIVED_SOURCES_DIR}/CyberKitPluginHostTypes.h)
    file(COPY
        mac/Plugins/Hosted/CyberKitPluginAgent.defs
        mac/Plugins/Hosted/CyberKitPluginAgentReply.defs
        mac/Plugins/Hosted/CyberKitPluginClient.defs
