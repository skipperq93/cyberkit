...
void SearchPopupMenuMac::saveRecentSearches(const AtomicString& name, const Vector<CyberCore::RecentSearch>& searchItems)
{
    CyberCore::saveRecentSearches(name, searchItems);
}

void SearchPopupMenuMac::loadRecentSearches(const AtomicString& name, Vector<CyberCore::RecentSearch>& searchItems)
{
    searchItems = CyberCore::loadRecentSearches(name);
}
