...
public:
    ...
    void saveRecentSearches(const AtomicString& name, const Vector<CyberCore::RecentSearch>&) override;
    void loadRecentSearches(const AtomicString& name, Vector<CyberCore::RecentSearch>&) override;
