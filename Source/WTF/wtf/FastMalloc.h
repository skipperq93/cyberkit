...
//     used outside of the component defining your class (e.g. your class is in CyberCore and it is also used in CyberKit). In this case, you can use WTF_MAKE_ISO_ALLOCATED_EXPORT
