...
cross_compiling = yes
cross_buildroot = /Users/matthewbenedict/Documents/git/CyberKit/Source/WTF/icu/build.noindex/host-arm-apple-darwin
...
SO_TARGET_VERSION = 76.1
SO_TARGET_VERSION_MAJOR = 76
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt76
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt76 
ICUDATA_CHAR = l
...
CFLAGS = -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk/usr/include/ -I./include/ -arch arm64 -miphoneos-version-min=11.0 -I/Users/matthewbenedict/Documents/git/CyberKit/Source/WTF/icu/build.noindex/icu/include/ -O3 -std=c11 -Wall -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS) 
# CXXFLAGS is for C++ only flags
CXXFLAGS = -stdlib=libc++ -std=c++17 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk/usr/include/ -I./include/ -arch arm64 -miphoneos-version-min=11.0 -I/Users/matthewbenedict/Documents/git/CyberKit/Source/WTF/icu/build.noindex/icu/include/ -O3 -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long $(THREADSCXXFLAGS) 
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS =  $(THREADSCPPFLAGS)  -DU_HAVE_STRTOD_L=1 -DU_HAVE_XLOCALE_H=1  -DU_DISABLE_RENAMING=1
...
LDFLAGS = -stdlib=libc++ -L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk/usr/lib/ -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk -Wl,-dead_strip -miphoneos-version-min=11.0 -lstdc++ $(RPATHLDFLAGS)
