...
$(OUT_DIR)/calendar.res: $(IN_DIR)/calendar.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) calendar.txt

$(OUT_DIR)/casing.res: $(IN_DIR)/casing.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) casing.txt

$(OUT_DIR)/conversion.res: $(IN_DIR)/conversion.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) conversion.txt

$(OUT_DIR)/format.res: $(IN_DIR)/format.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) format.txt

$(OUT_DIR)/icuio.res: $(IN_DIR)/icuio.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) icuio.txt

$(OUT_DIR)/idna_rules.res: $(IN_DIR)/idna_rules.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) idna_rules.txt

$(OUT_DIR)/mc.res: $(IN_DIR)/mc.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) mc.txt

$(OUT_DIR)/root.res: $(IN_DIR)/root.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) root.txt

$(OUT_DIR)/sh_YU.res: $(IN_DIR)/sh_YU.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) sh_YU.txt

$(OUT_DIR)/sh.res: $(IN_DIR)/sh.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) sh.txt

$(OUT_DIR)/structLocale.res: $(IN_DIR)/structLocale.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) structLocale.txt

$(OUT_DIR)/te_IN_REVISED.res: $(IN_DIR)/te_IN_REVISED.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) te_IN_REVISED.txt

$(OUT_DIR)/te_IN.res: $(IN_DIR)/te_IN.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) te_IN.txt

$(OUT_DIR)/te.res: $(IN_DIR)/te.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) te.txt

$(OUT_DIR)/testaliases.res: $(IN_DIR)/testaliases.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) testaliases.txt

$(OUT_DIR)/testempty.res: $(IN_DIR)/testempty.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) testempty.txt

$(OUT_DIR)/testtypes.res: $(IN_DIR)/testtypes.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) testtypes.txt

$(OUT_DIR)/Thai_graphclust_model4_heavy.res: $(IN_DIR)/Thai_graphclust_model4_heavy.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) Thai_graphclust_model4_heavy.txt

$(OUT_DIR)/Thai_codepoints_exclusive_model5_heavy.res: $(IN_DIR)/Thai_codepoints_exclusive_model5_heavy.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) Thai_codepoints_exclusive_model5_heavy.txt

$(OUT_DIR)/Burmese_graphclust_model5_heavy.res: $(IN_DIR)/Burmese_graphclust_model5_heavy.txt  | $(DIRS)
	$(INVOKE) $(TOOLBINDIR)/genrb -q -i $(LIBRARY_DATA_DIR) -s $(IN_DIR) -d $(OUT_DIR) Burmese_graphclust_model5_heavy.txt
...
Burmese_graphclust_model5_heavy.res
Thai_codepoints_exclusive_model5_heavy.res
Thai_graphclust_model4_heavy.res
calendar.res
casing.res
conversion.res
encoded.res
...
TESTDATA_ALL_OUTPUT_FILES = $(OUT_DIR)/Burmese_graphclust_model5_heavy.res \
		$(OUT_DIR)/Thai_codepoints_exclusive_model5_heavy.res \
		$(OUT_DIR)/Thai_graphclust_model4_heavy.res \
