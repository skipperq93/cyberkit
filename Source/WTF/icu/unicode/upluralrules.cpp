                ...
                UErrorCode *status)
{
    ...
    UnicodeString result = ((const PluralRules*)uplrules)->select(number);
                ...
                UErrorCode *status)
{
    ...
    UnicodeString result = ((const PluralRules*)uplrules)->select(*dq);
    return result.extract(keyword, capacity, *status);
}
                ...
                UErrorCode *status)
{
    ...
    UnicodeString result = ((const PluralRules*)uplrules)->select(impl, *status);
    return result.extract(keyword, capacity, *status);
}
