...
CFLAGS = -g -O0 -O2  -std=c11 -Wall -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CXXFLAGS is for C++ only flags
CXXFLAGS = -g -O0 -O2  -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long -std=c++11 -Wno-ambiguous-reversed-operator $(THREADSCXXFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS =  $(THREADSCPPFLAGS)  -DU_DEBUG=1 -DU_HAVE_STRTOD_L=1 -DU_HAVE_XLOCALE_H=1 -DU_HAVE_STRING_VIEW=1 
