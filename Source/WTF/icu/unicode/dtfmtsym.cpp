...
{
    int32_t row = std::numeric_limits<uint32_t>::max(), col;
    UBool failed = false;
...
DateFormatSymbols::copyData(const DateFormatSymbols& other) {
    ...
    if (other.fZoneStrings != nullptr) {
        ...
        createZoneStrings(const_cast<const UnicodeString**>((const UnicodeString* const*)other.fZoneStrings));
...
DateFormatSymbols::getZoneStrings(int32_t& rowCount, int32_t& columnCount) const
{
    ...
    if (fZoneStrings == nullptr) {
        ...
        result = const_cast<const UnicodeString**>((const UnicodeString* const*)fLocaleZoneStrings);
    } else {
        result = const_cast<const UnicodeString**>((const UnicodeString* const*)fZoneStrings);
    }
...
DateFormatSymbols::setZoneStrings(const UnicodeString* const *strings, int32_t rowCount, int32_t columnCount)
{
    ...
    createZoneStrings(const_cast<const UnicodeString**>((const UnicodeString* const*)strings));
}
