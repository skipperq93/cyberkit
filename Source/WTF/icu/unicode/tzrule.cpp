...
compareDates(const void * /*context*/, const void *left, const void *right) {
    UDate l = *((const UDate*)left);
    UDate r = *((const UDate*)right);
...
AnnualTimeZoneRule::operator==(const TimeZoneRule& that) const {
    ...
    AnnualTimeZoneRule *atzr = const_cast<AnnualTimeZoneRule*>((const AnnualTimeZoneRule*)&that);
...
AnnualTimeZoneRule::isEquivalentTo(const TimeZoneRule& other) const {
    ...
    AnnualTimeZoneRule* that = const_cast<AnnualTimeZoneRule*>((const AnnualTimeZoneRule*)&other);
...
TimeArrayTimeZoneRule::operator==(const TimeZoneRule& that) const {
    ...
    TimeArrayTimeZoneRule *tatzr = const_cast<TimeArrayTimeZoneRule*>((const TimeArrayTimeZoneRule*)&that);
...
TimeArrayTimeZoneRule::isEquivalentTo(const TimeZoneRule& other) const {
    ...
    TimeArrayTimeZoneRule* that = const_cast<TimeArrayTimeZoneRule*>((const TimeArrayTimeZoneRule*)&other);
