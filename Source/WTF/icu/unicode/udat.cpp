       ...
       UErrorCode *status)
{
    ...
    Format *res = ((const DateFormat*)fmt)->clone();
        ...
        UErrorCode*     status)
{
    ...
    ((const DateFormat*)format)->format(dateToFormat, res, fp);
        ...
        UErrorCode*     status)
{
    ...
    ((const DateFormat*)format)->format(*(Calendar*)calendar, res, fp);
        ...
        UErrorCode*     status)
{
    ...
    ((const DateFormat*)format)->format(dateToFormat, res, (FieldPositionIterator*)fpositer, *status);
        ...
        UErrorCode*     status)
{
    ...
    ((const DateFormat*)format)->format(*(Calendar*)calendar, res, (FieldPositionIterator*)fpositer, *status);
        ...
        UErrorCode      *status)
{
    ...
    res = ((const DateFormat*)format)->parse(src, pp);
                            ...
                            UErrorCode      *status)
{
    ...
    ((const DateFormat*)format)->parse(src, *(Calendar*)calendar, pp);
...
{
    return ((const DateFormat*)fmt)->isLenient();
}
                         ...
                         UErrorCode* status)
{
    ...
    return ((const DateFormat*)fmt)->getBooleanAttribute(attr, *status);
    //return false;
}
...
{
    return (const UCalendar*) ((const DateFormat*)fmt)->getCalendar();
}
...
{
    ((DateFormat*)fmt)->setCalendar(*((const Calendar*)calendarToSet));
}
...
udat_getNumberFormatForField(const UDateFormat* fmt, char16_t field)
{
    ...
    if (U_FAILURE(status)) return (const UNumberFormat*) ((const DateFormat*)fmt)->getNumberFormat();
    return (const UNumberFormat*) ((const SimpleDateFormat*)fmt)->getNumberFormatForField(field);
}

U_CAPI const UNumberFormat* U_EXPORT2
udat_getNumberFormat(const UDateFormat* fmt)
{
    return (const UNumberFormat*) ((const DateFormat*)fmt)->getNumberFormat();
}
...
{
    ((DateFormat*)fmt)->setNumberFormat(*((const NumberFormat*)numberFormatToSet));
}
...
{
    ((DateFormat*)fmt)->adoptNumberFormat(const_cast<NumberFormat*>((const NumberFormat*)numberFormatToAdopt));
}
                        ...
                        UErrorCode      *status)
{
    verifyIsSimpleDateFormat(fmt, status);
    if(U_FAILURE(*status)) return (UDate)0;
    return ((const SimpleDateFormat*)fmt)->get2DigitYearStart(*status);
}
            ...
            UErrorCode              *status)
{
    ...
    DateFormatSymbols *syms = const_cast<DateFormatSymbols*>((const DateFormatSymbols *)((SimpleDateFormat *)format)->getDateFormatSymbols());
                           ...
                           UErrorCode        *status)
{
    ...
    ((const RelativeDateFormat*)fmt)->toPatternDate(datePattern, *status);
                           ...
                           UErrorCode        *status)
{
    ...
    ((const RelativeDateFormat*)fmt)->toPatternTime(timePattern, *status);
