...
utrans_openInverse(const UTransliterator* trans,
    ...
    UTransliterator* result =
        (UTransliterator*) ((const Transliterator*) trans)->createInverse(*status);
...
utrans_clone(const UTransliterator* trans,
    ...
    Transliterator *t = ((const Transliterator*) trans)->clone();
    if (t == nullptr) {
...
utrans_getUnicodeID(const UTransliterator *trans,
    ...
    const UnicodeString &ID=((const Transliterator*) trans)->getID();
...
utrans_getID(const UTransliterator* trans,
             char* buf,
             int32_t bufCapacity) {
    return ((const Transliterator*) trans)->getID().extract(0, 0x7fffffff, buf, bufCapacity, US_INV);
}
...
utrans_trans(const UTransliterator* trans,
    ...
    *limit = ((const Transliterator*) trans)->transliterate(r, start, *limit);
}
...
utrans_transIncremental(const UTransliterator* trans,
    ...
    ((const Transliterator*) trans)->transliterate(r, *pos, *status);
}
...
utrans_transUChars(const UTransliterator* trans,
    ...
    *limit = ((const Transliterator*) trans)->transliterate(str, start, *limit);
...
utrans_transIncrementalUChars(const UTransliterator* trans,
    ...
    ((const Transliterator*) trans)->transliterate(str, *pos, *status);
...
utrans_toRules(     const UTransliterator* trans,
    ...
    ((const Transliterator*) trans)->toRules(res, escapeUnprintable);
...
utrans_getSourceSet(const UTransliterator* trans,
    ...
    if (ignoreFilter) {
        ((const Transliterator*) trans)->handleGetSourceSet(*((UnicodeSet*)fillIn));
    } else {
        ((const Transliterator*) trans)->getSourceSet(*((UnicodeSet*)fillIn));
    }
    return fillIn;
}
