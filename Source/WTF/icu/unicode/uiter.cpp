...
characterIteratorGetIndex(UCharIterator *iter, UCharIteratorOrigin origin) UPRV_NO_SANITIZE_UNDEFINED {
    ...
    case UITER_ZERO:
        return 0;
    case UITER_START:
        return ((const CharacterIterator *)(iter->context))->startIndex();
    case UITER_CURRENT:
        return ((const CharacterIterator *)(iter->context))->getIndex();
    case UITER_LIMIT:
        return ((const CharacterIterator *)(iter->context))->endIndex();
    case UITER_LENGTH:
        return ((const CharacterIterator *)(iter->context))->getLength();
    default:
        /* not a valid origin */
        /* Should never get here! */
        return -1;
...
characterIteratorMove(UCharIterator *iter, int32_t delta, UCharIteratorOrigin origin) UPRV_NO_SANITIZE_UNDEFINED {
    switch(origin) {
    case UITER_ZERO:
        const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->setIndex(delta);
        return ((const CharacterIterator *)(iter->context))->getIndex();
    case UITER_START:
    case UITER_CURRENT:
    case UITER_LIMIT:
        return const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->move(delta, (CharacterIterator::EOrigin)origin);
    case UITER_LENGTH:
        const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->\
            setIndex(const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->getLength()+delta);
        return ((const CharacterIterator *)(iter->context))->getIndex();
    default:
        /* not a valid origin */
        /* Should never get here! */
...
characterIteratorHasNext(UCharIterator *iter) {
    return const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->hasNext();
}

static UBool U_CALLCONV
characterIteratorHasPrevious(UCharIterator *iter) {
    return const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->hasPrevious();
}
...
characterIteratorCurrent(UCharIterator *iter) {
    ...
    c=((const CharacterIterator *)(iter->context))->current();
    if(c!=0xffff || const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->hasNext()) {
        return c;
    } else {
        return U_SENTINEL;
    }
...
characterIteratorNext(UCharIterator *iter) {
    if(const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->hasNext()) {
        return const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->nextPostInc();
    } else {
        return U_SENTINEL;
    }
}
...
characterIteratorPrevious(UCharIterator *iter) {
    if(const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->hasPrevious()) {
        return const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->previous();
    } else {
        return U_SENTINEL;
    }
}
...
characterIteratorGetState(const UCharIterator *iter) {
    return const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->getIndex();
}
...
characterIteratorSetState(UCharIterator *iter, uint32_t state, UErrorCode *pErrorCode) {
    if(pErrorCode==nullptr || U_FAILURE(*pErrorCode)) {
        ...
        *pErrorCode=U_ILLEGAL_ARGUMENT_ERROR;
    } else if((int32_t)state<((const CharacterIterator *)(iter->context))->startIndex() || \
              ((const CharacterIterator *)(iter->context))->endIndex()<(int32_t)state) {
        *pErrorCode=U_INDEX_OUTOFBOUNDS_ERROR;
    } else {
        const_cast<CharacterIterator*>((const CharacterIterator *)(iter->context))->setIndex((int32_t)state);
    }
}
...
replaceableIteratorCurrent(UCharIterator *iter) {
    if(iter->index<iter->limit) {
        return ((const Replaceable *)(iter->context))->charAt(iter->index);
    } else {
        return U_SENTINEL;
    }
}
