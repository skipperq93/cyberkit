        ...
        case 'v':
            {
                ...
                i16Ptr = const_cast<int16_t *>((const int16_t *)i8Ptr);
                i32Ptr = const_cast<int32_t *>((const int32_t *)i8Ptr);
                i64Ptr = const_cast<int64_t *>((const int64_t *)i8Ptr);
                ptrPtr = (void **)(const_cast<char*>(i8Ptr));
