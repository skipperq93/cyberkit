...
{
    return ((const NumberingSystem*)unumsys)->getName();
}
...
{
    return ((const NumberingSystem*)unumsys)->getRadix();
}
...
{
    return ((const NumberingSystem*)unumsys)->isAlgorithmic();
}
                       ...
                       int32_t resultLength, UErrorCode *status)
{
    ...
    // implement
    UnicodeString descrip = ((const NumberingSystem*)unumsys)->getDescription();
