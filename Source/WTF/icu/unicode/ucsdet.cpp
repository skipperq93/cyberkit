...
ucsdet_getName(const UCharsetMatch *ucsm, UErrorCode *status)
{
    ...
    return ((const CharsetMatch *) ucsm)->getName();
}
...
ucsdet_getConfidence(const UCharsetMatch *ucsm, UErrorCode *status)
{
    ...
    return ((const CharsetMatch *) ucsm)->getConfidence();
}
...
ucsdet_getLanguage(const UCharsetMatch *ucsm, UErrorCode *status)
{
    ...
    return ((const CharsetMatch *) ucsm)->getLanguage();
}
                 ...
                 int32_t *maxMatchesFound, UErrorCode *status)
{
    ...
    return const_cast<const UCharsetMatch**>((const UCharsetMatch* const*)(csd->detectAll(*maxMatchesFound,*status)));
}
...
ucsdet_isInputFilterEnabled(const UCharsetDetector *ucsd)
{
    ...
    return ((const CharsetDetector *) ucsd)->getStripTagsFlag();
}
                 ...
                 char16_t *buf, int32_t cap, UErrorCode *status)
{
    ...
    return ((const CharsetMatch *) ucsm)->getUChars(buf, cap, status);
}
...
{
    return ((const CharsetDetector *)ucsd)->getDetectableCharsets(*status);
}
