...
uregex_clone(const URegularExpression *source2, UErrorCode *status)  {
    RegularExpression *source = const_cast<RegularExpression*>((const RegularExpression*)source2);
...
uregex_pattern(const  URegularExpression *regexp2,
                      int32_t            *patLength,
                      UErrorCode         *status)  {
    RegularExpression *regexp = const_cast<RegularExpression*>((const RegularExpression*)regexp2);
...
uregex_regionEnd64(const  URegularExpression   *regexp2,
                          UErrorCode           *status)  {
    const RegularExpression *regexp = (const RegularExpression*)regexp2;
    if (validateRE(regexp, true, status) == false) {
        return 0;
    }
