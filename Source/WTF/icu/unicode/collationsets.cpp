...
enumTailoredRange(const void *context, UChar32 start, UChar32 end, uint32_t ce32) {
    ...
    TailoredSet *ts = const_cast<TailoredSet*>((const TailoredSet *)context);
...
enumCnERange(const void *context, UChar32 start, UChar32 end, uint32_t ce32) {
    ContractionsAndExpansions *cne = const_cast<ContractionsAndExpansions*>((const ContractionsAndExpansions *)context);
