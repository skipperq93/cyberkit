...
uset_clone(const USet *set) {
    return (USet*) (((const UnicodeSet*) set)->UnicodeSet::clone());
}

U_CAPI UBool U_EXPORT2
uset_isFrozen(const USet *set) {
    return ((const UnicodeSet*) set)->UnicodeSet::isFrozen();
}
...
uset_cloneAsThawed(const USet *set) {
    return (USet*) (((const UnicodeSet*) set)->UnicodeSet::cloneAsThawed());
}
...
uset_span(const USet *set, const char16_t *s, int32_t length, USetSpanCondition spanCondition) {
    return ((const UnicodeSet*) set)->UnicodeSet::span(s, length, spanCondition);
}

U_CAPI int32_t U_EXPORT2
uset_spanBack(const USet *set, const char16_t *s, int32_t length, USetSpanCondition spanCondition) {
    return ((const UnicodeSet*) set)->UnicodeSet::spanBack(s, length, spanCondition);
}

U_CAPI int32_t U_EXPORT2
uset_spanUTF8(const USet *set, const char *s, int32_t length, USetSpanCondition spanCondition) {
    return ((const UnicodeSet*) set)->UnicodeSet::spanUTF8(s, length, spanCondition);
}

U_CAPI int32_t U_EXPORT2
uset_spanBackUTF8(const USet *set, const char *s, int32_t length, USetSpanCondition spanCondition) {
    return ((const UnicodeSet*) set)->UnicodeSet::spanBackUTF8(s, length, spanCondition);
}
...
uset_indexOf(const USet* set, UChar32 c) {
    return ((const UnicodeSet*) set)->UnicodeSet::indexOf(c);
}

U_CAPI UChar32 U_EXPORT2
uset_charAt(const USet* set, int32_t index) {
    return ((const UnicodeSet*) set)->UnicodeSet::charAt(index);
}
