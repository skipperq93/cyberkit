...
udatpg_setDateTimeFormat(const UDateTimePatternGenerator *dtpg,
    ...
    const_cast<DateTimePatternGenerator*>((const DateTimePatternGenerator *)dtpg)->setDateTimeFormat(dtFormatString);
}
...
udatpg_openSkeletons(const UDateTimePatternGenerator *dtpg, UErrorCode *pErrorCode) {
    return uenum_openFromStringEnumeration(
                ((const DateTimePatternGenerator *)dtpg)->getSkeletons(*pErrorCode),
                pErrorCode);
}
...
udatpg_openBaseSkeletons(const UDateTimePatternGenerator *dtpg, UErrorCode *pErrorCode) {
    return uenum_openFromStringEnumeration(
                ((const DateTimePatternGenerator *)dtpg)->getBaseSkeletons(*pErrorCode),
                pErrorCode);
}
