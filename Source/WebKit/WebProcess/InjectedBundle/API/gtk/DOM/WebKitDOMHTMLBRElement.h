...
#ifndef CyberKitDOMHTMLBRElement_h
#define CyberKitDOMHTMLBRElement_h
...
#define WEBKIT_DOM_HTML_BR_ELEMENT(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), WEBKIT_DOM_TYPE_HTML_BR_ELEMENT, CyberKitDOMHTMLBRElement))
#define WEBKIT_DOM_HTML_BR_ELEMENT_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_DOM_TYPE_HTML_BR_ELEMENT, CyberKitDOMHTMLBRElementClass)
...
#define WEBKIT_DOM_HTML_BR_ELEMENT_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS((obj),  WEBKIT_DOM_TYPE_HTML_BR_ELEMENT, CyberKitDOMHTMLBRElementClass))

struct _CyberKitDOMHTMLBRElement {
    CyberKitDOMHTMLElement parent_instance;
};

struct _CyberKitDOMHTMLBRElementClass {
 ...
 * @self: A #CyberKitDOMHTMLBRElement
 *
 * Returns: A #gchar
 *
...
#endif /* CyberKitDOMHTMLBRElement_h */
