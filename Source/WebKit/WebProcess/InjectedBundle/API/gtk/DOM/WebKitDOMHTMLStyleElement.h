...
#ifndef CyberKitDOMHTMLStyleElement_h
#define CyberKitDOMHTMLStyleElement_h
...
#define WEBKIT_DOM_HTML_STYLE_ELEMENT(obj)            (G_TYPE_CHECK_INSTANCE_CAST((obj), WEBKIT_DOM_TYPE_HTML_STYLE_ELEMENT, CyberKitDOMHTMLStyleElement))
#define WEBKIT_DOM_HTML_STYLE_ELEMENT_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass),  WEBKIT_DOM_TYPE_HTML_STYLE_ELEMENT, CyberKitDOMHTMLStyleElementClass)
...
#define WEBKIT_DOM_HTML_STYLE_ELEMENT_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS((obj),  WEBKIT_DOM_TYPE_HTML_STYLE_ELEMENT, CyberKitDOMHTMLStyleElementClass))

struct _CyberKitDOMHTMLStyleElement {
    CyberKitDOMHTMLElement parent_instance;
};

struct _CyberKitDOMHTMLStyleElementClass {
 ...
 * @self: A #CyberKitDOMHTMLStyleElement
 *
 * Returns: A #gboolean
 *
...
#endif /* CyberKitDOMHTMLStyleElement_h */
