...
#include "config.h"
#include "CyberKitDOMHTMLUListElement.h"
...
CyberKitDOMHTMLUListElement* kit(CyberCore::HTMLUListElement* obj)
{
    return WEBKIT_DOM_HTML_U_LIST_ELEMENT(kit(static_cast<CyberCore::Node*>(obj)));
}

CyberCore::HTMLUListElement* core(CyberKitDOMHTMLUListElement* request)
{
    return request ? static_cast<CyberCore::HTMLUListElement*>(WEBKIT_DOM_OBJECT(request)->coreObject) : 0;
}

CyberKitDOMHTMLUListElement* wrapHTMLUListElement(CyberCore::HTMLUListElement* coreObject)
{
    ASSERT(coreObject);
...
static gboolean webkit_dom_html_u_list_element_dispatch_event(CyberKitDOMEventTarget* target, CyberKitDOMEvent* event, GError** error)
{
    CyberCore::Event* coreEvent = CyberKit::core(event);
    if (!coreEvent)
        return false;
    CyberCore::HTMLUListElement* coreTarget = static_cast<CyberCore::HTMLUListElement*>(WEBKIT_DOM_OBJECT(target)->coreObject);
...
static gboolean webkit_dom_html_u_list_element_add_event_listener(CyberKitDOMEventTarget* target, const char* eventName, GClosure* handler, gboolean useCapture)
{
    CyberCore::HTMLUListElement* coreTarget = static_cast<CyberCore::HTMLUListElement*>(WEBKIT_DOM_OBJECT(target)->coreObject);
    return CyberKit::GObjectEventListener::addEventListener(G_OBJECT(target), coreTarget, eventName, handler, useCapture);
}

static gboolean webkit_dom_html_u_list_element_remove_event_listener(CyberKitDOMEventTarget* target, const char* eventName, GClosure* handler, gboolean useCapture)
{
    CyberCore::HTMLUListElement* coreTarget = static_cast<CyberCore::HTMLUListElement*>(WEBKIT_DOM_OBJECT(target)->coreObject);
    return CyberKit::GObjectEventListener::removeEventListener(G_OBJECT(target), coreTarget, eventName, handler, useCapture);
}

static void webkit_dom_html_u_list_element_dom_event_target_init(CyberKitDOMEventTargetIface* iface)
{
...
G_DEFINE_TYPE_WITH_CODE(CyberKitDOMHTMLUListElement, webkit_dom_html_u_list_element, WEBKIT_DOM_TYPE_HTML_ELEMENT, G_IMPLEMENT_INTERFACE(WEBKIT_DOM_TYPE_EVENT_TARGET, webkit_dom_html_u_list_element_dom_event_target_init))
...
{
    CyberKitDOMHTMLUListElement* self = WEBKIT_DOM_HTML_U_LIST_ELEMENT(object);
...
static void webkit_dom_html_u_list_element_class_init(CyberKitDOMHTMLUListElementClass* requestClass)
{
...
static void webkit_dom_html_u_list_element_init(CyberKitDOMHTMLUListElement* request)
{
    UNUSED_PARAM(request);
}

gboolean webkit_dom_html_u_list_element_get_compact(CyberKitDOMHTMLUListElement* self)
{
    CyberCore::JSMainThreadNullState state;
    g_return_val_if_fail(WEBKIT_DOM_IS_HTML_U_LIST_ELEMENT(self), FALSE);
    CyberCore::HTMLUListElement* item = CyberKit::core(self);
    gboolean result = item->hasAttributeWithoutSynchronization(CyberCore::HTMLNames::compactAttr);
    return result;
}

void webkit_dom_html_u_list_element_set_compact(CyberKitDOMHTMLUListElement* self, gboolean value)
{
    CyberCore::JSMainThreadNullState state;
...
gchar* webkit_dom_html_u_list_element_get_type_attr(CyberKitDOMHTMLUListElement* self)
{
    CyberCore::JSMainThreadNullState state;
...
void webkit_dom_html_u_list_element_set_type_attr(CyberKitDOMHTMLUListElement* self, const gchar* value)
{
    CyberCore::JSMainThreadNullState state;
    g_return_if_fail(WEBKIT_DOM_IS_HTML_U_LIST_ELEMENT(self));
