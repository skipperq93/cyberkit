...
sys.stdout.write(
    ...
    '    var userAgentTemplate = "Mozilla/5.0 (%Platform%%Subplatform%) AppleCyberKit/%CyberKitVersion% (KHTML, like Gecko)"\n'
    '    var userAgentTemplateRegExp = /^Mozilla\\/5\\.0 \\(([^;]+; )*[^;]+\\) AppleCyberKit\\/[0-9\\.]+(\\+)? \\(KHTML, like Gecko\\).*$/;\n'
