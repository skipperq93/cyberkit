...
function copyTempDouble(ptr) {
  ...
  function _fflush(stream) {
      ...
      // we don't currently perform any user-space buffering of data
        ...
        Browser.BlobBuilder = typeof MozBlobBuilder != "undefined" ? MozBlobBuilder : (typeof CyberKitBlobBuilder != "undefined" ? CyberKitBlobBuilder : (!Browser.hasBlobConstructor ? console.log("warning: no BlobBuilder") : null));
