...
describe('CommitSet', () => {
    ...
    describe('diff',  () => {
        ...
        it('should describe commit difference', () => {
            ...
            assert.equal(CommitSet.diff(commitSetWithGitCommit(), anotherCommitSetWithGitCommit()), 'CyberKit-Git: 13a0590d..2f8dd332');
            assert.equal(CommitSet.diff(commitSetWithTwoCommits(), anotherCommitSetWithTwoCommits()), 'CyberKit: r12345-r45678 CyberKit-Git: 13a0590d..2f8dd332');
        });
