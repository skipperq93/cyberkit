...
var MockModels = {
    inject: function () {
        beforeEach(function () {
            ...
            MockModels.webkitGit = Repository.ensureSingleton(17, {name: 'CyberKit-Git'});
            MockModels.builder = new Builder(176, {name: 'CyberKit Perf Builder', buildUrl: 'http://build.webkit.org/builders/$builderName/$buildNumber'});
