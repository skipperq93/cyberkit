...
describe('/api/manifest', function () {
    ...
    it("should generate manifest with triggerables", () => {
        ...
        return Promise.all([
            ...
            assert.strictEqual(osWebkit1.name(), 'CyberKit');
            ...
            assert.strictEqual(groups[0].accepts(cusomSetWithOSXAndCyberKit), false);
            assert.strictEqual(groups[0].accepts(cusomSetWithCyberKitAndShared), false);
            assert.strictEqual(groups[0].accepts(cusomSetWithCyberKit), false);
            ...
            assert.strictEqual(groups[1].accepts(cusomSetWithOSXAndCyberKit), true);
            assert.strictEqual(groups[1].accepts(cusomSetWithCyberKitAndShared), false);
            assert.strictEqual(groups[1].accepts(cusomSetWithCyberKit), false);
            ...
            assert.strictEqual(groups[2].accepts(cusomSetWithOSXAndCyberKit), false);
            assert.strictEqual(groups[2].accepts(cusomSetWithCyberKitAndShared), true);
            assert.strictEqual(groups[2].accepts(cusomSetWithCyberKit), false);
        });
    });
