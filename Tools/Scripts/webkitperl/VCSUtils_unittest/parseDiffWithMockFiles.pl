...
my $diffBody = <<EOF;
+
 MODULES = CyberScriptCore JavaScriptGlue CyberCore CyberKit CyberKitTools
...
@@ -1,3 +1,4 @@\r
 MODULES = CyberScriptCore JavaScriptGlue CyberCore CyberKit CyberKitTools\r
 \r
-all:
...
@@ -1,3 +1,4 @@\r MODULES = CyberScriptCore JavaScriptGlue CyberCore CyberKit CyberKitTools\r \r-all:
\\ No newline at end of file
+all:\r+\r
EOF
    expectedReturn => [
