...
public:
    ...
    static void testHandlerMessageReceivedCallback(CyberKitUserContentManager* userContentManager, CyberKitJavascriptResult* javascriptResult, PolicyClientTest* test)
    {
