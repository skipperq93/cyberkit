...
// Include CyberKitSettingsPrivate.h for webkitSettingsSetMediaCaptureRequiresSecureConnection().
...
public:
    ...
    static void permissionResultMessageReceivedCallback(CyberKitUserContentManager* userContentManager, CyberKitJavascriptResult* javascriptResult, UIClientTest* test)
    {
...
#endif
    ModalDialogsTest::add("CyberKitWebView", "allow-modal-dialogs", testWebViewAllowModalDialogs);
    ModalDialogsTest::add("CyberKitWebView", "disallow-modal-dialogs", testWebViewDisallowModalDialogs);
