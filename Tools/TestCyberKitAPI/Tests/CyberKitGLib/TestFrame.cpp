...
{
    g_assert(test->runWebProcessTest("CyberKitFrame", "main-frame"));
}

static void testCyberKitFrameURI(WebViewTest* test, gconstpointer)
{
    g_assert(test->runWebProcessTest("CyberKitFrame", "uri"));
}

static void testCyberKitFrameJavaScriptContext(WebViewTest* test, gconstpointer)
{
    g_assert(test->runWebProcessTest("CyberKitFrame", "javascript-context"));
}
...
static void testCyberKitFrameJavaScriptValues(WebViewTest* test, gconstpointer)
{
    ...
    g_assert(test->runWebProcessTest("CyberKitFrame", "javascript-values", testHTML));
}
