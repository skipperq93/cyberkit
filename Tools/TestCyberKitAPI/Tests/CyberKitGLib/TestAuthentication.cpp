...
public:
    ...
    static void authenticationCancelledCallback(CyberKitAuthenticationRequest*, AuthenticationTest*)
    {
...
{
    auto httpsServer = std::make_unique<CyberKitTestServer>(CyberKitTestServer::ServerHTTPS);
