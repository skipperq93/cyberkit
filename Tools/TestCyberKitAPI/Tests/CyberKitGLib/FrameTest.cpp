...
private:
...
#if PLATFORM(GTK)
        G_GNUC_BEGIN_IGNORE_DEPRECATIONS;
        CyberKitDOMElement* p = webkit_dom_document_get_element_by_id(document, "paragraph");
        G_GNUC_END_IGNORE_DEPRECATIONS;
    ...
    static void willSubmitFormCallback(CyberKitWebPage* page, CyberKitDOMElement*, CyberKitFormSubmissionStep, CyberKitFrame* sourceFrame, CyberKitFrame*, GPtrArray*, GPtrArray*, gpointer userData)
    {
