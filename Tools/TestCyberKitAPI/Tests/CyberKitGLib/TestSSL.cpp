...
{
    CyberKitWebContext* context = webkit_web_view_get_context(test->m_webView);
    CyberKitTLSErrorsPolicy originalPolicy = webkit_web_context_get_tls_errors_policy(context);
...
void beforeAll()
{
    ...
    kHttpServer = new CyberKitTestServer(CyberKitTestServer::ServerHTTP);
