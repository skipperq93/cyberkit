...
public:
    ...
    {
#if PLATFORM(GTK)
        CyberKitFaviconDatabase* database = webkit_web_context_get_favicon_database(m_webContext.get());
    ...
    static void viewFaviconChangedCallback(CyberKitWebView* webView, GParamSpec* pspec, gpointer data)
    {
    ...
    {
        FaviconDatabaseTest* test = static_cast<FaviconDatabaseTest*>(data);
        CyberKitFaviconDatabase* database = webkit_web_context_get_favicon_database(test->m_webContext.get());
...
static void testWebViewFavicon(FaviconDatabaseTest* test)
{
    ...
    // but CyberKitFaviconDatabase::icon-changed isn't.
...
void beforeAll()
{
    ...
    FaviconDatabaseTest::add("CyberKitFaviconDatabase", "favicon-database-test", testFaviconDatabase);
}
