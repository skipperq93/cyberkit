...
#include "CyberKitTestBus.h"
#include "WebViewTest.h"
#include <wtf/glib/GRefPtr.h>

static CyberKitTestBus* bus;
...
{
    test->loadHtml("<html><head><title>CyberKitGTK+ Web Extensions Test</title></head><body></body></html>", 0);
    ...
    g_assert_cmpstr(title, ==, "CyberKitGTK+ Web Extensions Test");
}
