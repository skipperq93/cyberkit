...
public:
    ...
    static void downloadStartedCallback(CyberKitWebContext* context, CyberKitDownload* download, DownloadTest* test)
    {
...
public:
    ...
    static void downloadStartedCallback(CyberKitWebContext* context, CyberKitDownload* download, WebViewDownloadTest* test)
    {
