...
static void testWebsiteDataConfiguration(WebsiteDataTest* test, gconstpointer)
{
    ...
    CyberKitWebsiteDataManager* defaultManager = webkit_web_context_get_website_data_manager(webkit_web_context_get_default());
    ...
    GRefPtr<CyberKitWebsiteDataManager> baseDataManager = adoptGRef(webkit_website_data_manager_new("base-data-directory", Test::dataDirectory(), "base-cache-directory", Test::dataDirectory(), nullptr));
...
{
    static const CyberKitWebsiteDataTypes databaseTypes = static_cast<CyberKitWebsiteDataTypes>(WEBKIT_WEBSITE_DATA_WEBSQL_DATABASES | WEBKIT_WEBSITE_DATA_INDEXEDDB_DATABASES);
