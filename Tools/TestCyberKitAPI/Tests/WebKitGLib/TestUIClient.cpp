...
public:
    ...
    static void queryPermissionResultMessageReceivedCallback(CyberKitUserContentManager* userContentManager, CyberKitJavascriptResult* javascriptResult, UIClientTest* test)
    {
