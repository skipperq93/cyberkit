...
public:
    ...
    static gboolean showOptionMenuCallback(CyberKitWebView* webView, CyberKitOptionMenu* menu, GdkEvent* event, GdkRectangle* rect, OptionMenuTest* test)
    {
    ...
    void showOptionMenu(CyberKitOptionMenu* menu, GdkRectangle* rect)
    {
        m_rectangle = *rect;
        m_menu = menu;
