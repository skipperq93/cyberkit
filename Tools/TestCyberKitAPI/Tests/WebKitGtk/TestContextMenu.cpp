...
static void testContextMenuPopulateMenu(ContextMenuCustomTest* test, gconstpointer)
{
    ...
    GRefPtr<GtkAction> action = adoptGRef(gtk_action_new("CyberKitGTK+CustomAction", "Custom _Action", nullptr, nullptr));
    ...
    GRefPtr<GtkAction> toggleAction = adoptGRef(GTK_ACTION(gtk_toggle_action_new("CyberKitGTK+CustomToggleAction", "Custom _Toggle Action", nullptr, nullptr)));
    ...
    GRefPtr<GAction> gAction = adoptGRef(G_ACTION(g_simple_action_new("CyberKitGTK+CustomGAction", nullptr)));
    ...
    GRefPtr<GAction> toggleGAction = adoptGRef(G_ACTION(g_simple_action_new_stateful("CyberKitGTK+CustomToggleGAction", nullptr, g_variant_new_boolean(FALSE))));
    ...
    gAction = adoptGRef(G_ACTION(g_simple_action_new("CyberKitGTK+CustomGActionWithTarget", G_VARIANT_TYPE_STRING)));
    test->setAction(gAction.get(), "Custom _GAction With Target", g_variant_new_string("CyberKitGTK+CustomGActionTarget"));
    test->showContextMenuAndWaitUntilFinished();
...
public:
    ...
    bool contextMenu(CyberKitContextMenu* contextMenu, GdkEvent*, CyberKitHitTestResult*)
    {
        ...
        GRefPtr<GAction> toggleGAction = adoptGRef(G_ACTION(g_simple_action_new_stateful("CyberKitGTK+CustomToggleGAction", nullptr, g_variant_new_boolean(TRUE))));
