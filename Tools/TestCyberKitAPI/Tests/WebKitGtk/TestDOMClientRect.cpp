...
{
    g_assert(test->runWebProcessTest("CyberKitDOMClientRect", "div-bounding-client-rect-position", testHTML));
}

static void testCyberKitDOMClientRectDivClientRectsPositionAndLength(WebViewTest* test, gconstpointer)
{
    g_assert(test->runWebProcessTest("CyberKitDOMClientRect", "div-client-rects-position-and-length", testHTML));
}
