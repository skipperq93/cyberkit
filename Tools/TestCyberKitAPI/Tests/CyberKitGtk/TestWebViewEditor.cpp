...
public:
        ...
        : m_clipboard(m_mainLoop)
    {
        ...
        g_signal_connect(m_webView, "permission-request", G_CALLBACK(+[](CyberKitWebView*, CyberKitPermissionRequest* request, gpointer userData) {
    ...
    gboolean clipboardPermissionRequested(CyberKitPermissionRequest* request)
    {
...
void beforeAll()
{
    ...
    EditorTest::add("CyberKitWebView", "clipboard/permission-request", testWebViewClipboardPermissionRequest);
}
