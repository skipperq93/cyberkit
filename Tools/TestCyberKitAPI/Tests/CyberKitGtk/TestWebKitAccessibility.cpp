...
static void startTestServer()
{
    ...
    GUniquePtr<char> testServerPath(g_build_filename(WEBKIT_EXEC_PATH, "TestCyberKitAPI", "CyberKit2Gtk", kTestServerAppName, nullptr));
...
void beforeAll()
{
    ...
    startTestServer();
    WebViewTest::add("CyberKitAccessibility", "atspi-basic-hierarchy", testAtspiBasicHierarchy);
}
