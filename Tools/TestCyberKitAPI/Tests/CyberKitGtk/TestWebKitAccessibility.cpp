...
public:
    ...
    AccessibilityTest()
    {
        GUniquePtr<char> testServerPath(g_build_filename(WEBKIT_EXEC_PATH, "TestCyberKitAPI", "CyberKit2Gtk", "AccessibilityTestServer", nullptr));
        char* args[2];
...
void beforeAll()
{
    ...
    AccessibilityTest::add("CyberKitAccessibility", "atspi-basic-hierarchy", testAtspiBasicHierarchy);
}
