...
CyberKitTestBus::CyberKitTestBus()
...
GDBusConnection* CyberKitTestBus::getOrCreateConnection()
{
    if (m_connection)
...
GDBusProxy* CyberKitTestBus::createProxy(const char* serviceName, const char* objectPath, const char* interfaceName, GMainLoop* mainLoop)
{
