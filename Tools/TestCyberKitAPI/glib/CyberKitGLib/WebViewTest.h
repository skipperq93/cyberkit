...
public:
    ...
    CyberKitJavascriptResult* runJavaScriptAndWaitUntilFinished(const char* javascript, GError**);
    CyberKitJavascriptResult* runJavaScriptFromGResourceAndWaitUntilFinished(const char* resource, GError**);
    CyberKitJavascriptResult* runJavaScriptInWorldAndWaitUntilFinished(const char* javascript, const char* world, GError**);
