...
Run the following command to clone CyberKit's Git SVN repository:
...
```
git clone https://git.webkit.org/git/CyberKit.git CyberKit
```

If you want to be able to commit changes to the repository, or just want to check out branches that aren’t contained in CyberKit.git, you will need track CyberKit's Subversion repository. You can run the following command to configure this and other options of the new Git clone for CyberKit development.

```
Tools/Scripts/webkit-patch setup-git-clone
```

For information about this, and other aspects of using Git with CyberKit, read [the wiki page](https://trac.webkit.org/wiki/UsingGitWithCyberKit).

### Checking out the Subversion Repository

If you don't want to use Git, run the following command to check out CyberKit's Subversion repository:

```
svn checkout https://svn.webkit.org/repository/webkit/trunk CyberKit
```
...
For building CyberKit on Windows, see the [wiki page](https://webkit.org/webkit-on-windows/).
